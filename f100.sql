...
--   Application:     100
--   Name:            Sales
--   Date and Time:   15:57 Friday August 5, 2011
--   Exported By:     ADMIN
--   Flashback:       0
...
wwv_flow_api.create_flow(
  ...
  p_owner => nvl(wwv_flow_application_install.get_schema,'MDB_REP'),
  ...
  p_default_page_template=> 2614238398032776 + wwv_flow_api.g_id_offset,
  p_printer_friendly_template=> 2614445590032776 + wwv_flow_api.g_id_offset,
  ...
  p_checksum_salt_last_reset => '20110805155642',
  ...
  p_theme_id => 2,
  p_default_label_template => 2620143823033009 + wwv_flow_api.g_id_offset,
  p_default_report_template => 2619534456032954 + wwv_flow_api.g_id_offset,
  p_default_list_template => 2618636103032876 + wwv_flow_api.g_id_offset,
  p_default_menu_template => 2620420903033009 + wwv_flow_api.g_id_offset,
  p_default_button_template => 2614921232032777 + wwv_flow_api.g_id_offset,
  p_default_chart_template => 2615829971032830 + wwv_flow_api.g_id_offset,
  p_default_form_template => 2615925593032831 + wwv_flow_api.g_id_offset,
  p_default_wizard_template => 2617342166032836 + wwv_flow_api.g_id_offset,
  p_default_tabform_template => 2616718399032833 + wwv_flow_api.g_id_offset,
  p_default_reportr_template   =>2616718399032833 + wwv_flow_api.g_id_offset,
  ...
  p_last_upd_yyyymmddhh24miss=> '20110805155642',
...
wwv_flow_api.create_icon_bar_item(
  p_id => 2649139677137106 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_icon_sequence=> 10,
  p_icon_image => '',
...
wwv_flow_api.create_icon_bar_item(
  p_id => 2621744565033403 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_icon_sequence=> 200,
  p_icon_image => '',
...
--
--application/shared_components/logic/application_processes/addarea
...
wwv_flow_api.create_flow_process(
  p_id => 1301805666436403 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
...
wwv_flow_api.create_flow_item(
  p_id=> 2633138496096607 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
wwv_flow_api.create_tab (
  p_id=> 2623131309033686 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 10,
  p_tab_name=> 'T_HOME',
...
--application/shared_components/navigation/tabs/standard/pf
wwv_flow_api.create_tab (
  p_id=> 2661523332187893 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 20,
  p_tab_name=> 'PF',
  p_tab_text => 'Plan',
  p_tab_step => 3,
  p_tab_also_current_for_pages => '53',
  p_tab_parent_tabset=>'',
  p_tab_comment  => '');
 
--application/shared_components/navigation/tabs/standard/fact
wwv_flow_api.create_tab (
  p_id=> 1498604242850170 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 25,
  p_tab_name=> 'Fact',
  p_tab_text => 'Fact',
  p_tab_step => 54,
  p_tab_also_current_for_pages => '55',
  p_tab_parent_tabset=>'',
  p_tab_comment  => '');
 
--application/shared_components/navigation/tabs/standard/analytics
wwv_flow_api.create_tab (
  p_id=> 2693522700512935 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 40,
  p_tab_name=> 'Analytics',
...
wwv_flow_api.create_tab (
  p_id=> 2733428921399064 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 60,
  p_tab_name=> 'T_DICTIONARIES',
  p_tab_text => 'Dictionaries',
  p_tab_step => 7,
  p_tab_also_current_for_pages => '8,9,12,13,15,16,18,17,20,19,22,21,24,23,26,28,27,30,29,32,31,34,33,36,35,38,37,42,41,44,43,46,45,48,47,5,10,11,10,49,50,56,52',
  p_tab_parent_tabset=>'',
  p_tab_comment  => '');
 
--application/shared_components/navigation/tabs/standard/access_control
wwv_flow_api.create_tab (
  p_id=> 2677534944279695 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 70,
...
wwv_flow_api.create_list_of_values (
  p_id       => 2651735687153579 + wwv_flow_api.g_id_offset,
  p_flow_id  => wwv_flow.g_flow_id,
  p_lov_name => 'APEX_APPLICATION_MODE',
  p_lov_query=> '.'||to_char(2651735687153579 + wwv_flow_api.g_id_offset)||'.');
...
wwv_flow_api.create_static_lov_data (
  p_id=>2652045418153594 + wwv_flow_api.g_id_offset,
  p_lov_id=>2651735687153579 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2652218754153597 + wwv_flow_api.g_id_offset,
  p_lov_id=>2651735687153579 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2652419959153597 + wwv_flow_api.g_id_offset,
  p_lov_id=>2651735687153579 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2652622899153597 + wwv_flow_api.g_id_offset,
  p_lov_id=>2651735687153579 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_list_of_values (
  p_id       => 2654116932153716 + wwv_flow_api.g_id_offset,
  p_flow_id  => wwv_flow.g_flow_id,
  p_lov_name => 'APEX_APPLICATION_PRIV',
  p_lov_query=> '.'||to_char(2654116932153716 + wwv_flow_api.g_id_offset)||'.');
...
wwv_flow_api.create_static_lov_data (
  p_id=>2654415363153716 + wwv_flow_api.g_id_offset,
  p_lov_id=>2654116932153716 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>10,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2654629513153719 + wwv_flow_api.g_id_offset,
  p_lov_id=>2654116932153716 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>20,
...
wwv_flow_api.create_static_lov_data (
  p_id=>2654817074153719 + wwv_flow_api.g_id_offset,
  p_lov_id=>2654116932153716 + wwv_flow_api.g_id_offset,
  p_lov_disp_sequence=>30,
...
wwv_flow_api.create_page_plug (
  p_id=> 2623222537033702 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Home',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 2623440357033771 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 2643141314125811 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Pages',
  p_region_name=>'',
...
prompt  ...PAGE 2: Access Control Administration Page
--
...
wwv_flow_api.create_report_region (
  ...
  p_region_name=>'',
  p_template=> 2616718399032833+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_report_columns (
  ...
  p_named_lov=>2654116932153716 + wwv_flow_api.g_id_offset,
  p_lov_show_nulls=> 'NO',
  p_column_width=> '16',
  p_is_required=> false,
  p_pk_col_source=> s,
...
wwv_flow_api.create_page_button(
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P2_SETUP_ID',
...
wwv_flow_api.create_page_item(
  ...
  p_lov=> '.'||to_char(2651735687153579 + wwv_flow_api.g_id_offset)||'.',
...
wwv_flow_api.create_page_item(
  ...
  p_cMaxlength=> null,
  p_cHeight=> null,
  p_tag_attributes  => '2614921232032777',
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110802200818'
  );
null;
...
'"KAMREP",'||chr(10)||
'(select emp_name from all_employees where emp_id = "IDKAMREP" and emp_type=kamrep) KAMREPNAME,'||chr(10)||
'(select client from clients where idclient=td."IDCLIENT") Client,'||chr(10)||
'(select city from clients where idclient=td."IDCLIENT") ClientCity,'||chr(10)||
'(select prod from products where idprod=td."IDPROD") Product,'||chr(10)||
'(select hy from half_year where idhy = td."IDHY") HalfYear,'||chr(10)||
'(select y from years ';

s:=s||'where idy = td."IDY") Year,'||chr(10)||
'"PACKS_PLAN",'||chr(10)||
'"PACKS"'||chr(10)||
'from "#OWNER#"."TRANSACTIONS_DATA" td where trasaction_type = ''BR'''||chr(10)||
'order by idtran desc'||chr(10)||
'  '||chr(10)||
'';

wwv_flow_api.create_page_plug (
  p_id=> 1491418265620272 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_plug_name=> 'Plan',
  p_region_name=>'',
...
a1:=a1||'where idy = td."IDY") Year,'||chr(10)||
'"PACKS_PLAN",'||chr(10)||
'"PACKS"'||chr(10)||
'from "#OWNER#"."TRANSACTIONS_DATA" td where trasaction_type = ''BR'''||chr(10)||
'order by idtran desc'||chr(10)||
...
wwv_flow_api.create_worksheet(
  p_id=> 1491613986620272+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_region_id=> 1491418265620272+wwv_flow_api.g_id_offset,
  p_name=> 'Plan',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_detail_link=>'f?p=&APP_ID.:53:&SESSION.::&DEBUG.::P53_IDTRAN:#IDTRAN#',
...
wwv_flow_api.create_worksheet_column(
  p_id => 1491721742620272+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1491826376620276+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 1491613986620272+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'KAMREP',
  p_display_order          =>2,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'B',
  p_column_label           =>'Kamrep',
  p_report_label           =>'Kamrep',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1492425237620282+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 1491613986620272+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1492521096620282+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 1491613986620272+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1493309435652352+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 1491613986620272+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1497327761780706+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 1491613986620272+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1493405747652353+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 1491613986620272+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1493820863655706+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 1491613986620272+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'KAMREPNAME',
  p_display_order          =>10,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
...
begin
rc1:=rc1||'KAMREPNAME:CLIENT:CLIENTCITY:PRODUCT:HALFYEAR:YEAR:PACKS_PLAN:PACKS';

wwv_flow_api.create_worksheet_rpt(
  p_id => 1492802808622080+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 1491613986620272+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 2665427336188229 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
...
wwv_flow_api.create_page_button(
  p_id             => 1492731967620283 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 3,
  p_button_sequence=> 30,
  ...
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=100:53:&SESSION.::&DEBUG.:53',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_branch(
  p_id=>2665229450188186 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 3,
...
wwv_flow_api.create_page_process(
  p_id     => 2664735212188166 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 3,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 2664941843188178 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 3,
  p_process_sequence=> 20,
  p_process_point=> 'AFTER_SUBMIT',
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110712020722'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 2693625008512943 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
'var htmldb_delete_message=''"DELETE_CONFIRM_MSG"'';'
 ...
 ,p_cache_by_user_yn => 'N'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110803190120'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1519512058889767 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_plug (
  p_id=> 1520428089906378 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
...
wwv_flow_api.create_jstree(
  p_id => 1520312466906378+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id => 5,
  p_region_id => 1520428089906378+wwv_flow_api.g_id_offset,
  p_tree_template     =>'classic',
  p_tree_source             =>'',
  p_tree_query             =>a1,
  p_tree_node_title   =>'EMPLOYEE_NAME',
  p_tree_node_value   =>'EMPLOYEE_ID',
  p_tree_node_icon   =>'',
  p_tree_node_link   =>'',
  p_tree_node_hints   =>'EMPLOYEE_ID',
  p_tree_start_item   =>'EMPLOYEE_PARENT',
  p_tree_start_value   =>'',
  ...
  p_selected_node          =>'P5_CURRENTNODE');
end;
/
...
wwv_flow_api.create_page_button(
  p_id             => 1558809290969025 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 5,
...
wwv_flow_api.create_page_button(
  p_id             => 1559620203010090 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 5,
  p_button_sequence=> 30,
  p_button_plug_id => 1520428089906378+wwv_flow_api.g_id_offset,
  ...
  p_button_position=> 'ABOVE_BOX',
  p_button_alignment=> 'LEFT',
  p_button_redirect_url=> 'f?p=&APP_ID.:10:&SESSION.::&DEBUG.::P10_EMPLOYEE_ID,P10_EMPLOYEE_NAME:&P5_CURRENTNODE.,&P5_CURRENTNODE.',
  p_button_execute_validations=>'Y',
  p_button_condition_type=> 'NEVER',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 1520711229906395 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 5,
  p_button_sequence=> 10,
  p_button_plug_id => 1520428089906378+wwv_flow_api.g_id_offset,
  ...
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'javascript:apex.widget.tree.collapse_all(''tree'||to_char(1520312466906378+wwv_flow_api.g_id_offset)||''');',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 1520921427906414 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 5,
  p_button_sequence=> 10,
  p_button_plug_id => 1520428089906378+wwv_flow_api.g_id_offset,
  ...
  p_button_position=> 'REGION_TEMPLATE_CREATE',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'javascript:apex.widget.tree.expand_all(''tree'||to_char(1520312466906378+wwv_flow_api.g_id_offset)||''');',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_branch(
  p_id=>1547401623948125 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 5,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1553318893915066 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 5,
  p_name=>'P5_CURRENTNODE',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 1520428089906378+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Currentnode',
  p_source_type=> 'STATIC',
  p_display_as=> 'NATIVE_HIDDEN',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:CIP_SCHEMA_EMPL:IDCIPEMP';

wwv_flow_api.create_page_process(
  p_id     => 1546921764948124 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 5,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 1547121712948125 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 5,
  p_process_sequence=> 20,
  p_process_point=> 'AFTER_SUBMIT',
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110712192905'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 2711636542052863 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1608110500342386 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 7,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1615008816370293 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 7,
...
declare
  ...
  l_length number := 1;
begin
s:=s||'1615432018377056';

wwv_flow_api.create_page_plug (
  p_id=> 1621726608384973 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 7,
...
declare
  ...
  l_length number := 1;
begin
s:=s||'1622809340408319';

wwv_flow_api.create_page_plug (
  p_id=> 1623930811414536 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 7,
...
declare
  ...
  l_length number := 1;
begin
s:=s||'1624524493431663';

wwv_flow_api.create_page_plug (
  p_id=> 1625303846435174 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 7,
  p_plug_name=> 'CIP',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 2733619606399073 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 7,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 2745145010450647 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 7,
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110724185223'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1298503476227617 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
...
wwv_flow_api.create_page_plug (
  p_id=> 2750214344482963 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
...
wwv_flow_api.create_worksheet(
  p_id=> 2750444729482985+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_region_id=> 2750214344482963+wwv_flow_api.g_id_offset,
  p_name=> 'Report on AREAS',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:9:&APP_SESSION.::::P9_IDAREA:#IDAREA#',
  p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif"  border="0">',
  p_allow_exclude_null_values=>'Y',
  p_allow_hide_extra_columns=>'Y',
  p_icon_view_enabled_yn=>'N',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2750539288483096+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 2750632540483250+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 2750444729482985+wwv_flow_api.g_id_offset,
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'IDAREA:AREAS';

wwv_flow_api.create_worksheet_rpt(
  p_id => 2753125495511173+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 2750444729482985+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 2750917872483271 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 2750830222483257 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 8,
  p_button_sequence=> 30,
...
wwv_flow_api.create_page_branch(
  p_id=>1309022476273840 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 8,
...
wwv_flow_api.create_page_branch(
  p_id=>2759517605557559 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 8,
  p_branch_action=> 'f?p=&APP_ID.:8:&SESSION.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1298800144236131 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 8,
  p_name=>'P8_AREA',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 1298503476227617+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Areas',
  p_source_type=> 'STATIC',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1302900761681015 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 8,
  p_name=>'P8_X1',
  p_data_type=> 'VARCHAR',
  ...
  p_lov=> 'select areas, idarea from areas',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 30,
  p_cMaxlength=> 4000,
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:AREAS:IDAREA';

wwv_flow_api.create_page_process(
  p_id     => 1308521166273835 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 8,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 2759030642557506 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 8,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 1308717099273839 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 8,
  p_process_sequence=> 20,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 2759225757557537 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 8,
  p_process_sequence=> 20,
  p_process_point=> 'AFTER_SUBMIT',
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110724193307'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 2747413924482093 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 9,
  p_plug_name=> 'Details',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 2751130494483280 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 9,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 2747735256482299 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 9,
  p_button_sequence=> 30,
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P9_IDAREA',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 2748039923482317 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 9,
  p_button_sequence=> 10,
  p_button_plug_id => 2747413924482093+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 2747644107482299 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 9,
  p_button_sequence=> 40,
  p_button_plug_id => 2747413924482093+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 2747834420482299 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 9,
  p_button_sequence=> 20,
  p_button_plug_id => 2747413924482093+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>2748627206482337 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 9,
  p_branch_action=> 'f?p=&APP_ID.:8:&SESSION.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
...
begin
wwv_flow_api.create_page_item(
  p_id=>2748844765482349 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 9,
  p_name=>'P9_IDAREA',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 2747413924482093+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Idarea',
  p_source=>'IDAREA',
  p_source_type=> 'DB_COLUMN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>2749022490482524 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 9,
  p_name=>'P9_AREAS',
  p_data_type=> 'VARCHAR',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:AREAS:P9_IDAREA:IDAREA';

wwv_flow_api.create_page_process(
  p_id     => 2749328341482621 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 9,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:AREAS:P9_IDAREA:IDAREA|IUD';

wwv_flow_api.create_page_process(
  p_id     => 2749544663482726 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 9,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 2749733375482728 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 9,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
...
prompt  ...PAGE 10: Form on EMPLOYEE
--
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110803203115'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1553927757933985 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 10,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1557109311934049 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 10,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1554210287933997 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 10,
  p_button_sequence=> 30,
...
wwv_flow_api.create_page_button(
  p_id             => 1554523079933998 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 10,
  p_button_sequence=> 10,
  p_button_plug_id => 1553927757933985+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1554131486933997 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 10,
  p_button_sequence=> 40,
  p_button_plug_id => 1553927757933985+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1554316674933997 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 10,
  p_button_sequence=> 20,
  p_button_plug_id => 1553927757933985+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>1555100314934008 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10,
  p_branch_action=> 'f?p=&APP_ID.:5:&SESSION.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1555303285934012 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 1553927757933985+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1555509177934036 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10,
  p_name=>'P10_EMPLOYEE_PARENT',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 30,
  ...
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Parent',
  p_source=>'EMPLOYEE_PARENT',
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_lov=> 'select employee_name ||''-''||employee_type d, employee_id r from employee',
  p_lov_display_null=> 'YES',
  p_lov_translated=> 'N',
  p_lov_null_text=>'Без подчинения',
  p_lov_null_value=> '',
  p_cSize=> 32,
  p_cMaxlength=> 255,
  p_cHeight=> 1,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1555701000934039 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10,
  p_name=>'P10_EMPLOYEE_TYPE',
  p_data_type=> 'VARCHAR',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 20,
  ...
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_lov=> 'STATIC2:SKAM;SKAM,KAM;KAM,REP;REP',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 32,
  p_cMaxlength=> 100,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1555920237934039 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1556101211934039 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10,
  p_name=>'P10_EMPLOYEE_BU',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 50,
  ...
  p_source=>'EMPLOYEE_BU',
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_CHECKBOX',
  p_lov=> 'select busunit, idbusunit from busunits',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 32,
  p_cMaxlength=> 100,
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:EMPLOYEE:P10_EMPLOYEE_ID:EMPLOYEE_ID';

wwv_flow_api.create_page_process(
  p_id     => 1556431656934042 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 10,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
...
wwv_flow_api.create_page_process(
  p_id     => 1556628450934048 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 10,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:EMPLOYEE:P10_EMPLOYEE_ID:EMPLOYEE_ID|IUD';

wwv_flow_api.create_page_process(
  p_id     => 1556819185934048 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 10,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 1557025296934048 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 10,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page (
 ...
 ,p_id => 12
 ,p_tab_set => 'TS1'
 ,p_name => 'Report on REGS'
 ,p_step_title => 'Report on REGS'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_help_text => 
...
wwv_flow_api.create_page_plug (
  p_id=> 1316000404508797 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 12,
  p_plug_name=> 'Regions',
  p_region_name=>'',
...
wwv_flow_api.create_worksheet(
  p_id=> 1316208129508801+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 12,
  p_region_id=> 1316000404508797+wwv_flow_api.g_id_offset,
  p_name=> 'Regions',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:13:&SESSION.::&DEBUG.::P13_IDREG:#IDREG#',
  p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif"  border="0">',
  p_allow_exclude_null_values=>'N',
  p_allow_hide_extra_columns=>'N',
  p_icon_view_enabled_yn=>'N',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1316309582508812+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 12,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1316420268508817+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 12,
  p_worksheet_id => 1316208129508801+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'REG',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1316531533508818+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 12,
  p_worksheet_id => 1316208129508801+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1316622648508819+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 12,
  p_worksheet_id => 1316208129508801+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'SUBAREA',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1319020615571449+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 12,
  p_worksheet_id => 1316208129508801+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'IDAREA',
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'IDREG:REG:CAP:SUBAREA:IDAREA';

wwv_flow_api.create_worksheet_rpt(
  p_id => 1317906669510651+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 12,
  p_worksheet_id => 1316208129508801+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1317023958508820 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 12,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1316929184508820 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 12,
  p_button_sequence=> 30,
  ...
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=100:13:&SESSION.::&DEBUG.:13',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110724193241'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1312325066508758 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 13,
  p_plug_name=> 'Details',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1317203165508822 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 13,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1312616880508762 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 13,
  p_button_sequence=> 30,
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P13_IDREG',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 1312930726508766 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 13,
  p_button_sequence=> 10,
  p_button_plug_id => 1312325066508758+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1312526093508762 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 13,
  p_button_sequence=> 40,
  p_button_plug_id => 1312325066508758+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1312726330508763 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 13,
  p_button_sequence=> 20,
  p_button_plug_id => 1312325066508758+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>1313505976508768 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 13,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1313724018508768 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 13,
  p_name=>'P13_IDREG',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 1312325066508758+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Idreg',
  p_source=>'IDREG',
  p_source_type=> 'DB_COLUMN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1313915526508778 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 13,
  p_name=>'P13_REG',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1314128437508779 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 13,
  p_name=>'P13_CAP',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1314308563508779 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 13,
  p_name=>'P13_SUBAREA',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1314510816508779 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 13,
  p_name=>'P13_IDAREA',
  p_data_type=> 'VARCHAR',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:REGS:P13_IDREG:IDREG';

wwv_flow_api.create_page_process(
  p_id     => 1314812534508782 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 13,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
...
wwv_flow_api.create_page_process(
  p_id     => 1315001161508786 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 13,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:REGS:P13_IDREG:IDREG|IUD';

wwv_flow_api.create_page_process(
  p_id     => 1315230727508786 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 13,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 1315429854508787 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 13,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
...
prompt  ...PAGE 15: Report on BUSUNITS
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 15
 ,p_tab_set => 'TS1'
 ,p_name => 'Report on BUSUNITS'
 ,p_step_title => 'List of Business Units'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110805111113'
  );
null;
...
wwv_flow_api.create_page_plug (
  p_id=> 1338518306710694 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 15,
...
wwv_flow_api.create_worksheet(
  p_id=> 1338715758710694+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 15,
  p_region_id=> 1338518306710694+wwv_flow_api.g_id_offset,
  p_name=> 'Business Units',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  p_max_row_count=> '10000',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:16:&APP_SESSION.::::P16_IDBUSUNIT:#IDBUSUNIT#',
  p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif"  border="0">',
  p_allow_exclude_null_values=>'Y',
  p_allow_hide_extra_columns=>'Y',
  p_icon_view_enabled_yn=>'N',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1338822762710698+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 15,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1338907269710698+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 15,
  p_worksheet_id => 1338715758710694+wwv_flow_api.g_id_offset,
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'IDBUSUNIT:BUSUNIT';

wwv_flow_api.create_worksheet_rpt(
  p_id => 1340013922711446+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 15,
  p_worksheet_id => 1338715758710694+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1339220046710698 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 15,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1339130591710698 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 15,
  p_button_sequence=> 30,
  ...
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=100:16:&SESSION.::&DEBUG.:16',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
prompt  ...PAGE 16: Form on BUSUNITS
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 16
 ,p_tab_set => 'TS1'
 ,p_name => 'Form on BUSUNITS'
 ,p_step_title => 'Business Unit Detail'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110805111139'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1335413206710650 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 16,
  p_plug_name=> 'Details',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1339412163710699 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 16,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1335717273710651 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 16,
  p_button_sequence=> 30,
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P16_IDBUSUNIT',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 1336017554710653 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 16,
  p_button_sequence=> 10,
  p_button_plug_id => 1335413206710650+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1335610347710650 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 16,
  p_button_sequence=> 40,
  p_button_plug_id => 1335413206710650+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1335804263710651 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 16,
  p_button_sequence=> 20,
  p_button_plug_id => 1335413206710650+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>1336610246710656 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 16,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1336814398710658 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 16,
  p_name=>'P16_IDBUSUNIT',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 1335413206710650+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Idbusunit',
  p_source=>'IDBUSUNIT',
  p_source_type=> 'DB_COLUMN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1337010964710672 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 16,
  p_name=>'P16_BUSUNIT',
  p_data_type=> 'VARCHAR',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:BUSUNITS:P16_IDBUSUNIT:IDBUSUNIT';

wwv_flow_api.create_page_process(
  p_id     => 1337327324710682 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 16,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
...
wwv_flow_api.create_page_process(
  p_id     => 1337515982710685 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 16,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:BUSUNITS:P16_IDBUSUNIT:IDBUSUNIT|IUD';

wwv_flow_api.create_page_process(
  p_id     => 1337711156710685 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 16,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 1337902223710686 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 16,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
...
prompt  ...PAGE 17: Report on CLIENTS
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 17
 ,p_tab_set => 'TS1'
 ,p_name => 'Report on CLIENTS'
 ,p_step_title => 'List of Clients'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110805124215'
  );
null;
...
wwv_flow_api.create_page_plug (
  p_id=> 1348400590749647 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 17,
  p_plug_name=> 'Clients',
  p_region_name=>'',
...
wwv_flow_api.create_worksheet(
  p_id=> 1348631966749648+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 17,
  p_region_id=> 1348400590749647+wwv_flow_api.g_id_offset,
  p_name=> 'Clients',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:18:&SESSION.::&DEBUG.::P18_IDCLIENT:#IDCLIENT#',
  p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif"  border="0">',
  p_allow_exclude_null_values=>'N',
  p_allow_hide_extra_columns=>'N',
  p_icon_view_enabled_yn=>'N',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1348719592749648+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 17,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1348801812749649+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 17,
  p_worksheet_id => 1348631966749648+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'CLIENT',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1348924085749649+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 17,
  p_worksheet_id => 1348631966749648+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'CITY',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1351020343826806+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 17,
  p_worksheet_id => 1348631966749648+wwv_flow_api.g_id_offset,
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'CLIENT:CITY:REGION';

wwv_flow_api.create_worksheet_rpt(
  p_id => 1350116178749881+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 17,
  p_worksheet_id => 1348631966749648+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1349328099749649 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 17,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1349209658749649 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 17,
  p_button_sequence=> 30,
  ...
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=100:18:&SESSION.::&DEBUG.:18',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page (
 ...
 ,p_id => 18
 ,p_tab_set => 'TS1'
 ,p_name => 'Form on CLIENTS'
 ,p_step_title => 'Client Details'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110805130816'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1344918364749637 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 18,
  p_plug_name=> 'Details',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1349518209749650 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 18,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1345209169749639 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 18,
  p_button_sequence=> 30,
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P18_IDCLIENT',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 1345507950749639 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 18,
  p_button_sequence=> 10,
  p_button_plug_id => 1344918364749637+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1345119186749639 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 18,
  p_button_sequence=> 40,
  p_button_plug_id => 1344918364749637+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1345303506749639 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 18,
  p_button_sequence=> 20,
  p_button_plug_id => 1344918364749637+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>1346108101749642 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 18,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1346307135749643 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 18,
  p_name=>'P18_IDCLIENT',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 1344918364749637+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Idclient',
  p_source=>'IDCLIENT',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1346521719749643 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 18,
  p_name=>'P18_CLIENT',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1346717809749644 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 18,
  p_name=>'P18_CITY',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1346919460749644 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 18,
  p_name=>'P18_IDREG',
  p_data_type=> 'VARCHAR',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:CLIENTS:P18_IDCLIENT:IDCLIENT';

wwv_flow_api.create_page_process(
  p_id     => 1347218671749645 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 18,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
...
wwv_flow_api.create_page_process(
  p_id     => 1347428617749646 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 18,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:CLIENTS:P18_IDCLIENT:IDCLIENT|IUD';

wwv_flow_api.create_page_process(
  p_id     => 1347616037749646 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 18,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 1347815694749646 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 18,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
...
prompt  ...PAGE 19: Report on YEARS
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 19
 ,p_tab_set => 'TS1'
 ,p_name => 'Report on YEARS'
 ,p_step_title => 'List of Years'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110805130940'
  );
null;
...
wwv_flow_api.create_page_plug (
  p_id=> 1355023985929070 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 19,
  p_plug_name=> 'Years',
  p_region_name=>'',
...
wwv_flow_api.create_worksheet(
  p_id=> 1355211637929070+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 19,
  p_region_id=> 1355023985929070+wwv_flow_api.g_id_offset,
  p_name=> 'Years',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:20:&SESSION.::&DEBUG.::P20_IDY:#IDY#',
  p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif"  border="0">',
  p_allow_exclude_null_values=>'N',
  p_allow_hide_extra_columns=>'N',
  p_icon_view_enabled_yn=>'N',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1355325411929071+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 19,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1355417085929071+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 19,
  p_worksheet_id => 1355211637929070+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'Y',
...
wwv_flow_api.create_worksheet_rpt(
  p_id => 1356515551929491+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 19,
  p_worksheet_id => 1355211637929070+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1355727118929072 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 19,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1355603841929072 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 19,
  p_button_sequence=> 30,
  ...
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=100:20:&SESSION.::&DEBUG.:20',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page (
 ...
 ,p_id => 20
 ,p_tab_set => 'TS1'
 ,p_name => 'Form on YEARS'
 ,p_step_title => 'Year Details'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110805130917'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1351900517929054 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 20,
  p_plug_name=> 'Details',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1355908797929072 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 20,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1352202117929055 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 20,
  p_button_sequence=> 30,
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P20_IDY',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 1352507016929055 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 20,
  p_button_sequence=> 10,
  p_button_plug_id => 1351900517929054+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1352123738929055 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 20,
  p_button_sequence=> 40,
  p_button_plug_id => 1351900517929054+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1352315147929055 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 20,
  p_button_sequence=> 20,
  p_button_plug_id => 1351900517929054+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>1353126374929056 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 20,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1353329581929058 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 20,
  p_name=>'P20_IDY',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 1351900517929054+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Idy',
  p_source=>'IDY',
  p_source_type=> 'DB_COLUMN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1353520389929059 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 20,
  p_name=>'P20_Y',
  p_data_type=> 'VARCHAR',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:YEARS:P20_IDY:IDY';

wwv_flow_api.create_page_process(
  p_id     => 1353824010929064 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 20,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
...
wwv_flow_api.create_page_process(
  p_id     => 1354027906929065 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 20,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:YEARS:P20_IDY:IDY|IUD';

wwv_flow_api.create_page_process(
  p_id     => 1354222592929065 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 20,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 1354418607929065 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 20,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
...
prompt  ...PAGE 21: Report on HALF_YEAR
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 21
 ,p_tab_set => 'TS1'
 ,p_name => 'Report on HALF_YEAR'
 ,p_step_title => 'List of Half Years'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110805131020'
  );
null;
...
wwv_flow_api.create_page_plug (
  p_id=> 1362310812990291 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 21,
...
wwv_flow_api.create_worksheet(
  p_id=> 1362508262990293+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 21,
  p_region_id=> 1362310812990291+wwv_flow_api.g_id_offset,
  p_name=> 'Half Year',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:22:&SESSION.::&DEBUG.::P22_IDHY:#IDHY#',
  p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif"  border="0">',
  p_allow_exclude_null_values=>'N',
  p_allow_hide_extra_columns=>'N',
  p_icon_view_enabled_yn=>'N',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1362625593990293+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 21,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1362726912990295+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 21,
  p_worksheet_id => 1362508262990293+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'HY',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1364019585996858+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 21,
  p_worksheet_id => 1362508262990293+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'YEAR',
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'IDHY:HY:YEAR';

wwv_flow_api.create_worksheet_rpt(
  p_id => 1364403785001829+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 21,
  p_worksheet_id => 1362508262990293+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1363123357990296 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 21,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1363010868990296 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 21,
  p_button_sequence=> 30,
  ...
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=100:22:&SESSION.::&DEBUG.:22',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
prompt  ...PAGE 22: Form on HALF_YEAR
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 22
 ,p_tab_set => 'TS1'
 ,p_name => 'Form on HALF_YEAR'
 ,p_step_title => 'Half Year Details'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110805131057'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1359022727990279 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 22,
  p_plug_name=> 'Details',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1363327748990296 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 22,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1359313094990279 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 22,
  p_button_sequence=> 30,
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P22_IDHY',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 1359629753990279 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 22,
  p_button_sequence=> 10,
  p_button_plug_id => 1359022727990279+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1359232063990279 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 22,
  p_button_sequence=> 40,
  p_button_plug_id => 1359022727990279+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1359422529990279 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 22,
  p_button_sequence=> 20,
  p_button_plug_id => 1359022727990279+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>1360232586990281 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1360422721990281 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22,
  p_name=>'P22_IDHY',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 1359022727990279+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Idhy',
  p_source=>'IDHY',
  p_source_type=> 'DB_COLUMN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1360611557990281 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22,
  p_name=>'P22_HY',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1360818658990286 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22,
  p_name=>'P22_IDY',
  p_data_type=> 'VARCHAR',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:HALF_YEAR:P22_IDHY:IDHY';

wwv_flow_api.create_page_process(
  p_id     => 1361119248990286 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 22,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
...
wwv_flow_api.create_page_process(
  p_id     => 1361315732990287 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 22,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:HALF_YEAR:P22_IDHY:IDHY|IUD';

wwv_flow_api.create_page_process(
  p_id     => 1361506084990287 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 22,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 1361706920990288 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 22,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110805131255'
  );
null;
...
wwv_flow_api.create_page_plug (
  p_id=> 1368503675030493 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 23,
...
wwv_flow_api.create_worksheet(
  p_id=> 1368724406030493+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 23,
  p_region_id=> 1368503675030493+wwv_flow_api.g_id_offset,
  p_name=> 'Distributors',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:24:&SESSION.::&DEBUG.::P24_IDWS:#IDWS#',
  p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif"  border="0">',
  p_allow_exclude_null_values=>'N',
  p_allow_hide_extra_columns=>'N',
  p_icon_view_enabled_yn=>'N',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1368800531030494+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 23,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1368915761030498+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 23,
  p_worksheet_id => 1368724406030493+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'WS',
...
wwv_flow_api.create_worksheet_rpt(
  p_id => 1370402924039428+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 23,
  p_worksheet_id => 1368724406030493+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1369219033030499 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 23,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1369108013030499 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 23,
  p_button_sequence=> 30,
  ...
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=100:24:&SESSION.::&DEBUG.:24',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110805131313'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1365427036030474 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 24,
  p_plug_name=> 'Details',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1369426686030499 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 24,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1365700708030474 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 24,
  p_button_sequence=> 30,
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P24_IDWS',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 1366014812030475 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 24,
  p_button_sequence=> 10,
  p_button_plug_id => 1365427036030474+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1365620505030474 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 24,
  p_button_sequence=> 40,
  p_button_plug_id => 1365427036030474+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1365800072030474 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 24,
  p_button_sequence=> 20,
  p_button_plug_id => 1365427036030474+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>1366627349030479 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 24,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1366817251030480 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 24,
  p_name=>'P24_IDWS',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 1365427036030474+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Idws',
  p_source=>'IDWS',
  p_source_type=> 'DB_COLUMN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1367022139030480 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 24,
  p_name=>'P24_WS',
  p_data_type=> 'VARCHAR',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:WSS:P24_IDWS:IDWS';

wwv_flow_api.create_page_process(
  p_id     => 1367305825030480 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 24,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
...
wwv_flow_api.create_page_process(
  p_id     => 1367523841030481 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 24,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:WSS:P24_IDWS:IDWS|IUD';

wwv_flow_api.create_page_process(
  p_id     => 1367722470030482 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 24,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 1367902035030482 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 24,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page (
 ...
 ,p_id => 25
 ,p_tab_set => 'TS1'
 ,p_name => 'Report on REPS'
 ,p_step_title => 'Report on REPS'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_help_text => 
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110725004510'
  );
null;
...
wwv_flow_api.create_page_plug (
  p_id=> 1375423656110036 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 25,
  p_plug_name=> 'Reps',
  p_region_name=>'',
...
wwv_flow_api.create_worksheet(
  p_id=> 1375623391110036+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 25,
  p_region_id=> 1375423656110036+wwv_flow_api.g_id_offset,
  p_name=> 'Reps',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:26:&SESSION.::&DEBUG.::P26_IDREP:#IDREP#',
  p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif"  border="0">',
  p_allow_exclude_null_values=>'Y',
  p_allow_hide_extra_columns=>'Y',
  p_icon_view_enabled_yn=>'N',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1375705610110040+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 25,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1375817101110040+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 25,
  p_worksheet_id => 1375623391110036+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1377130769132602+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 25,
  p_worksheet_id => 1375623391110036+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'BUSUNIT',
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'IDREP:EMP:BUSUNIT';

wwv_flow_api.create_worksheet_rpt(
  p_id => 1377727091140973+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 25,
  p_worksheet_id => 1375623391110036+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1376231088110042 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 25,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1376114438110041 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 25,
  p_button_sequence=> 30,
  ...
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=100:26:&SESSION.::&DEBUG.:26',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110724210516'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1372103524110018 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 26,
  p_plug_name=> 'Details',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1376406725110042 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 26,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1372411915110018 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 26,
  p_button_sequence=> 30,
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P26_IDREP',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 1372721700110019 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 26,
  p_button_sequence=> 10,
  p_button_plug_id => 1372103524110018+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1372320878110018 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 26,
  p_button_sequence=> 40,
  p_button_plug_id => 1372103524110018+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1372528777110018 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 26,
  p_button_sequence=> 20,
  p_button_plug_id => 1372103524110018+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>1373319195110029 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 26,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1373521350110029 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 26,
  p_name=>'P26_IDREP',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 1372103524110018+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Idrep',
  p_source=>'IDREP',
  p_source_type=> 'DB_COLUMN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1373702473110031 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 26,
  p_name=>'P26_EMP',
  p_data_type=> 'VARCHAR',
...
begin
h := null;
h:=h||'If employee works for more than one business unit enter them separated by comma';

wwv_flow_api.create_page_item(
  p_id=>1373915417110032 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 26,
  p_name=>'P26_IDBUSUNIT',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 30,
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:REPS:P26_IDREP:IDREP';

wwv_flow_api.create_page_process(
  p_id     => 1374215807110033 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 26,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
...
wwv_flow_api.create_page_process(
  p_id     => 1374403761110033 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 26,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:REPS:P26_IDREP:IDREP|IUD';

wwv_flow_api.create_page_process(
  p_id     => 1374616769110033 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 26,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 1374830880110034 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 26,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
...
prompt  ...PAGE 27: Report on SENKAMS
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 27
 ,p_tab_set => 'TS1'
 ,p_name => 'Report on SENKAMS'
 ,p_step_title => 'Report on SENKAMS'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_help_text => 
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110724201129'
  );
null;
...
wwv_flow_api.create_page_plug (
  p_id=> 1382526127188897 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 27,
...
wwv_flow_api.create_worksheet(
  p_id=> 1382706261188898+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 27,
  p_region_id=> 1382526127188897+wwv_flow_api.g_id_offset,
  p_name=> 'Senior KAMs',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:28:&SESSION.::&DEBUG.::P28_IDSENKAM:#IDSENKAM#',
  p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif"  border="0">',
  p_allow_exclude_null_values=>'N',
  p_allow_hide_extra_columns=>'N',
  p_icon_view_enabled_yn=>'N',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1382812724188898+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 27,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1382913755188905+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 27,
  p_worksheet_id => 1382706261188898+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'SENKAM',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1384217834195078+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 27,
  p_worksheet_id => 1382706261188898+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'AREA',
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'IDSENKAM:SENKAM:AREA';

wwv_flow_api.create_worksheet_rpt(
  p_id => 1385015110222732+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 27,
  p_worksheet_id => 1382706261188898+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1383318774188907 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 27,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1383216627188906 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 27,
  p_button_sequence=> 30,
  ...
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=100:28:&SESSION.::&DEBUG.:28',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
prompt  ...PAGE 28: Form on SENKAMS
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 28
 ,p_tab_set => 'TS1'
 ,p_name => 'Form on SENKAMS'
 ,p_step_title => 'Form on SENKAMS'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_javascript_code => 
'var htmldb_delete_message=''"DELETE_CONFIRM_MSG"'';'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110724201322'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1379213204188890 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 28,
  p_plug_name=> 'Details',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1383501491188907 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 28,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1379525263188891 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 28,
  p_button_sequence=> 30,
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P28_IDSENKAM',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 1379831257188892 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 28,
  p_button_sequence=> 10,
  p_button_plug_id => 1379213204188890+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1379415065188891 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 28,
  p_button_sequence=> 40,
  p_button_plug_id => 1379213204188890+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1379619180188891 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 28,
  p_button_sequence=> 20,
  p_button_plug_id => 1379213204188890+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>1380412587188893 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 28,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1380624553188893 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 28,
  p_name=>'P28_IDSENKAM',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 1379213204188890+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Idsenkam',
  p_source=>'IDSENKAM',
  p_source_type=> 'DB_COLUMN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1380832046188894 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 28,
  p_name=>'P28_SENKAM',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1381026668188894 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 28,
  p_name=>'P28_IDAREA',
  p_data_type=> 'VARCHAR',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:SENKAMS:P28_IDSENKAM:IDSENKAM';

wwv_flow_api.create_page_process(
  p_id     => 1381307216188895 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 28,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
...
wwv_flow_api.create_page_process(
  p_id     => 1381518208188895 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 28,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:SENKAMS:P28_IDSENKAM:IDSENKAM|IUD';

wwv_flow_api.create_page_process(
  p_id     => 1381713957188895 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 28,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 1381909880188895 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 28,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page (
 ...
 ,p_id => 29
 ,p_tab_set => 'TS1'
 ,p_name => 'Report on KAMS'
 ,p_step_title => 'Report on KAMS'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_help_text => 
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110724201640'
  );
null;
...
wwv_flow_api.create_page_plug (
  p_id=> 1389107328233125 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 29,
  p_plug_name=> 'KAMs',
  p_region_name=>'',
...
wwv_flow_api.create_worksheet(
  p_id=> 1389324823233125+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 29,
  p_region_id=> 1389107328233125+wwv_flow_api.g_id_offset,
  p_name=> 'KAMs',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:30:&SESSION.::&DEBUG.::P30_IDKAM:#IDKAM#',
  p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif"  border="0">',
  p_allow_exclude_null_values=>'N',
  p_allow_hide_extra_columns=>'N',
  p_icon_view_enabled_yn=>'N',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1389407946233126+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 29,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1389512213233126+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 29,
  p_worksheet_id => 1389324823233125+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'KAM',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1391008793239815+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 29,
  p_worksheet_id => 1389324823233125+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'SENKAM',
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'IDKAM:KAM:SENKAM';

wwv_flow_api.create_worksheet_rpt(
  p_id => 1391406499248604+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 29,
  p_worksheet_id => 1389324823233125+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1389907722233149 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 29,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1389812661233149 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 29,
  p_button_sequence=> 30,
  ...
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=100:30:&SESSION.::&DEBUG.:30',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110724201741'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1385825604233102 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 30,
  p_plug_name=> 'Details',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1390114424233152 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 30,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1386109525233106 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 30,
  p_button_sequence=> 30,
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P30_IDKAM',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 1386409449233106 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 30,
  p_button_sequence=> 10,
  p_button_plug_id => 1385825604233102+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1386001053233106 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 30,
  p_button_sequence=> 40,
  p_button_plug_id => 1385825604233102+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1386211768233106 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 30,
  p_button_sequence=> 20,
  p_button_plug_id => 1385825604233102+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>1387018894233109 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1387225060233110 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30,
  p_name=>'P30_IDKAM',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 1385825604233102+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Idkam',
  p_source=>'IDKAM',
  p_source_type=> 'DB_COLUMN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1387409283233111 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30,
  p_name=>'P30_KAM',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1387613700233111 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30,
  p_name=>'P30_IDSENKAM',
  p_data_type=> 'VARCHAR',
  ...
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_lov=> 'select senkam, idsenkam from senkams',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 22,
  p_cMaxlength=> 255,
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:KAMS:P30_IDKAM:IDKAM';

wwv_flow_api.create_page_process(
  p_id     => 1387904604233117 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 30,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
...
wwv_flow_api.create_page_process(
  p_id     => 1388111433233118 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 30,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:KAMS:P30_IDKAM:IDKAM|IUD';

wwv_flow_api.create_page_process(
  p_id     => 1388328579233119 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 30,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 1388503972233119 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 30,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
...
prompt  ...PAGE 31: Report on MONTHS
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 31
 ,p_tab_set => 'TS1'
 ,p_name => 'Report on MONTHS'
 ,p_step_title => 'List of Months'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110805131134'
  );
null;
...
wwv_flow_api.create_page_plug (
  p_id=> 1395520172265289 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 31,
  p_plug_name=> 'Months',
  p_region_name=>'',
...
wwv_flow_api.create_worksheet(
  p_id=> 1395730043265293+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 31,
  p_region_id=> 1395520172265289+wwv_flow_api.g_id_offset,
  p_name=> 'Months',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:32:&SESSION.::&DEBUG.::P32_IDMONTH:#IDMONTH#',
  p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif"  border="0">',
  p_allow_exclude_null_values=>'Y',
  p_allow_hide_extra_columns=>'Y',
  p_icon_view_enabled_yn=>'N',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1395820775265294+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 31,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1395924138265295+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 31,
  p_worksheet_id => 1395730043265293+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1397402044275728+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 31,
  p_worksheet_id => 1395730043265293+wwv_flow_api.g_id_offset,
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'IDMONTH:MONTH:HALF_YEAR';

wwv_flow_api.create_worksheet_rpt(
  p_id => 1398015812298577+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 31,
  p_worksheet_id => 1395730043265293+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1396300412265297 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 31,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1396202507265297 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 31,
  p_button_sequence=> 30,
  ...
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=100:32:&SESSION.::&DEBUG.:32',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page (
 ...
 ,p_id => 32
 ,p_tab_set => 'TS1'
 ,p_name => 'Form on MONTHS'
 ,p_step_title => 'Month Details'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110805131156'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1392213731265287 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 32,
  p_plug_name=> 'Details',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1396524291265297 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 32,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1392503842265287 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 32,
  p_button_sequence=> 30,
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P32_IDMONTH',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 1392808241265287 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 32,
  p_button_sequence=> 10,
  p_button_plug_id => 1392213731265287+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1392427171265287 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 32,
  p_button_sequence=> 40,
  p_button_plug_id => 1392213731265287+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1392624755265287 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 32,
  p_button_sequence=> 20,
  p_button_plug_id => 1392213731265287+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>1393423340265288 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 32,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1393607637265288 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 32,
  p_name=>'P32_IDMONTH',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 1392213731265287+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Idmonth',
  p_source=>'IDMONTH',
  p_source_type=> 'DB_COLUMN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1393821020265288 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 32,
  p_name=>'P32_MONTH',
  p_data_type=> 'VARCHAR',
  ...
  p_protection_level => 'N',
  p_escape_on_http_output => 'Y',
  p_attribute_02 => '190001010000',
  p_attribute_03 => '210001010000',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1394001140265288 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 32,
  p_name=>'P32_IDHY',
  p_data_type=> 'VARCHAR',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:MONTHS:P32_IDMONTH:IDMONTH';

wwv_flow_api.create_page_process(
  p_id     => 1394323607265288 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 32,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
...
wwv_flow_api.create_page_process(
  p_id     => 1394512429265289 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 32,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:MONTHS:P32_IDMONTH:IDMONTH|IUD';

wwv_flow_api.create_page_process(
  p_id     => 1394719956265289 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 32,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 1394900261265289 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 32,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
...
prompt  ...PAGE 33: Report on PAYOUT_CURVE
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 33
 ,p_tab_set => 'TS1'
 ,p_name => 'Report on PAYOUT_CURVE'
 ,p_step_title => 'Payout Curve'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110805132857'
  );
null;
...
wwv_flow_api.create_page_plug (
  p_id=> 1402507551375551 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 33,
...
wwv_flow_api.create_worksheet(
  p_id=> 1402723685375552+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 33,
  p_region_id=> 1402507551375551+wwv_flow_api.g_id_offset,
  p_name=> 'Payout Curve',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:34:&SESSION.::&DEBUG.::P34_IDPAYOUT:#IDPAYOUT#',
  p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif"  border="0">',
  p_allow_exclude_null_values=>'N',
  p_allow_hide_extra_columns=>'N',
  p_icon_view_enabled_yn=>'N',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1402817462375552+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 33,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1402914066375553+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 33,
  p_worksheet_id => 1402723685375552+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'YTDGOAL',
  p_display_order          =>2,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'B',
  p_column_label           =>'YTD Goal',
  p_report_label           =>'YTD Goal',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1403021576375553+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 33,
  p_worksheet_id => 1402723685375552+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'TARGETINC',
  p_display_order          =>3,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'C',
  p_column_label           =>'Target Increase',
  p_report_label           =>'Target Increase',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'IDPAYOUT:YTDGOAL:TARGETINC';

wwv_flow_api.create_worksheet_rpt(
  p_id => 1404610543391698+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 33,
  p_worksheet_id => 1402723685375552+wwv_flow_api.g_id_offset,
  p_session_id  => null,
  ...
  p_application_user => 'APXWS_DEFAULT',
  p_report_seq              =>10,
  p_report_alias            =>'14047',
  p_status                  =>'PUBLIC',
  p_category_id             =>null+wwv_flow_api.g_id_offset,
  p_is_default              =>'Y',
  p_display_rows            =>100000,
  p_report_columns          =>rc1,
  p_sort_column_1           =>'YTDGOAL',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1403317932375553 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 33,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1595009444490523 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 33,
...
wwv_flow_api.create_page_button(
  p_id             => 1403216196375553 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 33,
  p_button_sequence=> 30,
...
wwv_flow_api.create_page_branch(
  p_id=>1596429927522362 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 33,
  p_branch_action=> 'f?p=&FLOW_ID.:33:&SESSION.',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
  p_branch_sequence=> 99,
  p_save_state_before_branch_yn=>'Y',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1595322042503638 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 33,
  p_name=>'P33_STARTWITH',
  p_data_type=> 'VARCHAR',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 1595009444490523+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Start With',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1595611091509910 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 33,
  p_name=>'P33_THRESHOLD',
  p_data_type=> 'VARCHAR',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 20,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1595829099515131 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 33,
  p_name=>'P33_EXELENCE',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1596221265522362 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 33,
  p_name=>'P33_GENERATE',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_process(
  p_id     => 1596520142540922 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 33,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
prompt  ...PAGE 34: Form on PAYOUT_CURVE
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 34
 ,p_tab_set => 'TS1'
 ,p_name => 'Form on PAYOUT_CURVE'
 ,p_step_title => 'Payout Curve Details'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110805132918'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1399212175375535 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 34,
  p_plug_name=> 'Details',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1403504937375553 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 34,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1399514720375536 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 34,
  p_button_sequence=> 30,
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P34_IDPAYOUT',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 1399820592375536 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 34,
  p_button_sequence=> 10,
  p_button_plug_id => 1399212175375535+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1399405431375536 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 34,
  p_button_sequence=> 40,
  p_button_plug_id => 1399212175375535+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1399603460375536 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 34,
  p_button_sequence=> 20,
  p_button_plug_id => 1399212175375535+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>1400423495375538 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 34,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1400608456375539 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 34,
  p_name=>'P34_IDPAYOUT',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 1399212175375535+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Idpayout',
  p_source=>'IDPAYOUT',
  p_source_type=> 'DB_COLUMN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1400821500375539 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 34,
  p_name=>'P34_YTDGOAL',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1401002317375540 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 34,
  p_name=>'P34_TARGETINC',
  p_data_type=> 'VARCHAR',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 30,
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:PAYOUT_CURVE:P34_IDPAYOUT:IDPAYOUT';

wwv_flow_api.create_page_process(
  p_id     => 1401316799375541 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 34,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
...
wwv_flow_api.create_page_process(
  p_id     => 1401528454375547 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 34,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:PAYOUT_CURVE:P34_IDPAYOUT:IDPAYOUT|IUD';

wwv_flow_api.create_page_process(
  p_id     => 1401731353375547 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 34,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 1401915037375548 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 34,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
...
prompt  ...PAGE 35: Report on PRODGRS
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 35
 ,p_tab_set => 'TS1'
 ,p_name => 'Report on PRODGRS'
 ,p_step_title => 'List of Product Groups'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110805133820'
  );
null;
...
wwv_flow_api.create_page_plug (
  p_id=> 1408716501418617 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 35,
...
wwv_flow_api.create_worksheet(
  p_id=> 1408923548418618+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 35,
  p_region_id=> 1408716501418617+wwv_flow_api.g_id_offset,
  p_name=> 'Product Group',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  p_max_row_count=> '10000',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:36:&SESSION.::&DEBUG.::P36_IDPRODGR:#IDPRODGR#',
  p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif"  border="0">',
  p_allow_exclude_null_values=>'N',
  p_allow_hide_extra_columns=>'N',
  p_icon_view_enabled_yn=>'N',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1409017029418619+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 35,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1409122496418620+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 35,
  p_worksheet_id => 1408923548418618+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1410608296428913+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 35,
  p_worksheet_id => 1408923548418618+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'BUSUNIT',
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'IDPRODGR:PRODGR:BUSUNIT';

wwv_flow_api.create_worksheet_rpt(
  p_id => 1411010851439064+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 35,
  p_worksheet_id => 1408923548418618+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1409530434418621 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 35,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1409416852418621 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 35,
  p_button_sequence=> 30,
  ...
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=100:36:&SESSION.::&DEBUG.:36',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
prompt  ...PAGE 36: Form on PRODGRS
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 36
 ,p_tab_set => 'TS1'
 ,p_name => 'Form on PRODGRS'
 ,p_step_title => 'Product Group Details'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110805133846'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1405403508418602 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 36,
  p_plug_name=> 'Details',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1409724962418621 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 36,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1405713830418602 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 36,
  p_button_sequence=> 30,
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P36_IDPRODGR',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 1406014599418602 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 36,
  p_button_sequence=> 10,
  p_button_plug_id => 1405403508418602+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1405601923418602 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 36,
  p_button_sequence=> 40,
  p_button_plug_id => 1405403508418602+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1405813210418602 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 36,
  p_button_sequence=> 20,
  p_button_plug_id => 1405403508418602+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>1406621713418611 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 36,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1406823703418611 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 36,
  p_name=>'P36_IDPRODGR',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 1405403508418602+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Idprodgr',
  p_source=>'IDPRODGR',
  p_source_type=> 'DB_COLUMN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1407007087418612 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 36,
  p_name=>'P36_PRODGR',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1407203313418613 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 36,
  p_name=>'P36_IDBUSUNIT',
  p_data_type=> 'VARCHAR',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 30,
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:PRODGRS:P36_IDPRODGR:IDPRODGR';

wwv_flow_api.create_page_process(
  p_id     => 1407518626418614 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 36,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
...
wwv_flow_api.create_page_process(
  p_id     => 1407711469418614 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 36,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:PRODGRS:P36_IDPRODGR:IDPRODGR|IUD';

wwv_flow_api.create_page_process(
  p_id     => 1407930191418615 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 36,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 1408124623418615 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 36,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
...
prompt  ...PAGE 37: Report on PRODUCTS
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 37
 ,p_tab_set => 'TS1'
 ,p_name => 'Report on PRODUCTS'
 ,p_step_title => 'List of Products'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110805133930'
  );
null;
...
wwv_flow_api.create_page_plug (
  p_id=> 1416207692461192 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 37,
  p_plug_name=> 'Products',
  p_region_name=>'',
...
wwv_flow_api.create_worksheet(
  p_id=> 1416408959461192+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 37,
  p_region_id=> 1416207692461192+wwv_flow_api.g_id_offset,
  p_name=> 'Products',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:38:&SESSION.::&DEBUG.::P38_IDPROD:#IDPROD#',
  p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif"  border="0">',
  p_allow_exclude_null_values=>'N',
  p_allow_hide_extra_columns=>'N',
  p_icon_view_enabled_yn=>'N',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1416524379461192+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 37,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1416607516461193+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 37,
  p_worksheet_id => 1416408959461192+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PROD',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1418627175472205+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 37,
  p_worksheet_id => 1416408959461192+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1416821823461193+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 37,
  p_worksheet_id => 1416408959461192+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1416917786461194+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 37,
  p_worksheet_id => 1416408959461192+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1417028685461195+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 37,
  p_worksheet_id => 1416408959461192+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1417126671461195+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 37,
  p_worksheet_id => 1416408959461192+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1417201344461195+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 37,
  p_worksheet_id => 1416408959461192+wwv_flow_api.g_id_offset,
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'IDPROD:PROD:PRODUCTGROUP:PRICECIP:PRICENET:STARTDATE:ENDDATE:REMARKS';

wwv_flow_api.create_worksheet_rpt(
  p_id => 1420331031501749+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 37,
  p_worksheet_id => 1416408959461192+wwv_flow_api.g_id_offset,
  p_session_id  => null,
  ...
  p_application_user => 'APXWS_DEFAULT',
  p_report_seq              =>10,
  p_report_alias            =>'14204',
  p_status                  =>'PUBLIC',
  p_category_id             =>null+wwv_flow_api.g_id_offset,
  p_is_default              =>'Y',
  p_display_rows            =>100000,
  p_report_columns          =>rc1,
  p_sort_column_1           =>'PROD',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1417517343461195 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 37,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1417424347461195 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 37,
  p_button_sequence=> 30,
  ...
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=100:38:&SESSION.::&DEBUG.:38',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
prompt  ...PAGE 38: Form on PRODUCTS
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 38
 ,p_tab_set => 'TS1'
 ,p_name => 'Form on PRODUCTS'
 ,p_step_title => 'Form on PRODUCTS'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_javascript_code => 
'var htmldb_delete_message=''"DELETE_CONFIRM_MSG"'';'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110805095650'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1411906118461161 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 38,
  p_plug_name=> 'Details',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1417709792461196 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 38,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1412225647461161 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 38,
  p_button_sequence=> 30,
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P38_IDPROD',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 1412521753461173 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 38,
  p_button_sequence=> 10,
  p_button_plug_id => 1411906118461161+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1412115107461161 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 38,
  p_button_sequence=> 40,
  p_button_plug_id => 1411906118461161+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1412312887461161 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 38,
  p_button_sequence=> 20,
  p_button_plug_id => 1411906118461161+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>1413110295461175 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 38,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1413321819461175 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 38,
  p_name=>'P38_IDPROD',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 1411906118461161+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Idprod',
  p_source=>'IDPROD',
  p_source_type=> 'DB_COLUMN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1413517323461176 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 38,
  p_name=>'P38_PROD',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1413716614461177 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 38,
  p_name=>'P38_IDPRODGR',
  p_data_type=> 'VARCHAR',
  ...
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_lov=> 'select prodgr, idprodgr from prodgrs',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 22,
  p_cMaxlength=> 255,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1413925450461177 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 38,
  p_name=>'P38_PRICECIP',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1414116653461179 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 38,
  p_name=>'P38_PRICENET',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1414330791461179 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 38,
  p_name=>'P38_STARTDATE',
  p_data_type=> 'VARCHAR',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 60,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1414523377461180 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 38,
  p_name=>'P38_ENDDATE',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1414704420461180 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 38,
  p_name=>'P38_REMARKS',
  p_data_type=> 'VARCHAR',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:PRODUCTS:P38_IDPROD:IDPROD';

wwv_flow_api.create_page_process(
  p_id     => 1415021919461181 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 38,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
...
wwv_flow_api.create_page_process(
  p_id     => 1415217212461182 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 38,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:PRODUCTS:P38_IDPROD:IDPROD|IUD';

wwv_flow_api.create_page_process(
  p_id     => 1415411932461184 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 38,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 1415603676461185 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 38,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
...
prompt  ...PAGE 41: Report on DISCOUNTS
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 41
 ,p_tab_set => 'TS1'
 ,p_name => 'Report on DISCOUNTS'
 ,p_step_title => 'List of Discounts'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110805143018'
  );
null;
...
wwv_flow_api.create_page_plug (
  p_id=> 1425526707612959 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 41,
...
wwv_flow_api.create_worksheet(
  p_id=> 1425720607612959+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 41,
  p_region_id=> 1425526707612959+wwv_flow_api.g_id_offset,
  p_name=> 'Discounts',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:42:&SESSION.::&DEBUG.::P42_CODE:#CODE#',
  p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif"  border="0">',
  p_allow_exclude_null_values=>'N',
  p_allow_hide_extra_columns=>'N',
  p_icon_view_enabled_yn=>'N',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1425830688612959+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 41,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1427807931627504+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 41,
  p_worksheet_id => 1425720607612959+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1427904452627505+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 41,
  p_worksheet_id => 1425720607612959+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1428030384627505+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 41,
  p_worksheet_id => 1425720607612959+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1426219149612961+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 41,
  p_worksheet_id => 1425720607612959+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'IDMONTH',
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'CODE:DISTRIBUTOR:PROGUCTGROUP:DISC:IDMONTH';

wwv_flow_api.create_worksheet_rpt(
  p_id => 1428230787634108+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 41,
  p_worksheet_id => 1425720607612959+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1426504248612961 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 41,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1426410991612961 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 41,
  p_button_sequence=> 30,
  ...
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=100:42:&SESSION.::&DEBUG.:42',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
prompt  ...PAGE 42: Form on DISCOUNTS
--
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110805141352'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1421829726612951 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 42,
  p_plug_name=> 'Details',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1426709609612961 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 42,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1422108219612956 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 42,
  p_button_sequence=> 30,
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P42_CODE',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 1422402014612956 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 42,
  p_button_sequence=> 10,
  p_button_plug_id => 1421829726612951+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1422007164612956 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 42,
  p_button_sequence=> 40,
  p_button_plug_id => 1421829726612951+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1422203892612956 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 42,
  p_button_sequence=> 20,
  p_button_plug_id => 1421829726612951+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>1423012532612956 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 42,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1423219260612956 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 42,
  p_name=>'P42_CODE',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 1421829726612951+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Code',
  p_source=>'CODE',
  p_source_type=> 'DB_COLUMN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1423411799612957 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 42,
  p_name=>'P42_IDWS',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1423622935612957 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 42,
  p_name=>'P42_IDPRODGR',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1423802690612957 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 42,
  p_name=>'P42_DISC',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1424016665612957 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 42,
  p_name=>'P42_IDMONTH',
  p_data_type=> 'VARCHAR',
  ...
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_CHECKBOX',
  p_lov=> 'select month, idmonth from months order by 2 desc',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 60,
  p_cMaxlength=> 255,
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:DISCOUNTS:P42_CODE:CODE';

wwv_flow_api.create_page_process(
  p_id     => 1424313544612957 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 42,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
...
wwv_flow_api.create_page_process(
  p_id     => 1424515245612958 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 42,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:DISCOUNTS:P42_CODE:CODE|IUD';

wwv_flow_api.create_page_process(
  p_id     => 1424716493612958 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 42,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 1424912067612958 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 42,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
...
prompt  ...PAGE 43: Report on CIP_SCHEMA
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 43
 ,p_tab_set => 'TS1'
 ,p_name => 'Report on CIP_SCHEMA'
 ,p_step_title => 'List of CIP Schemas'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110805143343'
  );
null;
...
wwv_flow_api.create_page_plug (
  p_id=> 1434014307266851 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 43,
...
wwv_flow_api.create_worksheet(
  p_id=> 1434214810266851+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 43,
  p_region_id=> 1434014307266851+wwv_flow_api.g_id_offset,
  p_name=> 'CIP Schema',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:44:&SESSION.::&DEBUG.::P44_IDSCHEMA:#IDSCHEMA#',
  p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif"  border="0">',
  p_allow_exclude_null_values=>'Y',
  p_allow_hide_extra_columns=>'Y',
  p_icon_view_enabled_yn=>'N',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1434305504266851+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 43,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1434415516266853+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 43,
  p_worksheet_id => 1434214810266851+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1436214547282322+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 43,
  p_worksheet_id => 1434214810266851+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'HALFYEAR',
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'IDSCHEMA:SCHEMA_NAME:HALFYEAR:YEAR';

wwv_flow_api.create_worksheet_rpt(
  p_id => 1436828184295684+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 43,
  p_worksheet_id => 1434214810266851+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1434906534266853 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 43,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1434831196266853 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 43,
  p_button_sequence=> 30,
  ...
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=100:44:&SESSION.::&DEBUG.:44',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
prompt  ...PAGE 44: Form on CIP_SCHEMA
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 44
 ,p_tab_set => 'TS1'
 ,p_name => 'Form on CIP_SCHEMA'
 ,p_step_title => 'CIP Schema Details'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110805143404'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1430514637266845 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 44,
  p_plug_name=> 'Details',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1435124118266853 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 44,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1430823076266845 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 44,
  p_button_sequence=> 30,
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P44_IDSCHEMA',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 1431132127266846 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 44,
  p_button_sequence=> 10,
  p_button_plug_id => 1430514637266845+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1430708996266845 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 44,
  p_button_sequence=> 40,
  p_button_plug_id => 1430514637266845+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1430910864266845 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 44,
  p_button_sequence=> 20,
  p_button_plug_id => 1430514637266845+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>1431710422266846 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 44,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1431929651266846 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 44,
  p_name=>'P44_IDSCHEMA',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 1430514637266845+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Idschema',
  p_source=>'IDSCHEMA',
  p_source_type=> 'DB_COLUMN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1432107539266847 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 44,
  p_name=>'P44_SCHEMA_NAME',
  p_data_type=> 'VARCHAR',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 20,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1432306494266847 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 44,
  p_name=>'P44_IDHY',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1432515129266848 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 44,
  p_name=>'P44_IDY',
  p_data_type=> 'VARCHAR',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:CIP_SCHEMA:P44_IDSCHEMA:IDSCHEMA';

wwv_flow_api.create_page_process(
  p_id     => 1432830163266848 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 44,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
...
wwv_flow_api.create_page_process(
  p_id     => 1433015905266848 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 44,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:CIP_SCHEMA:P44_IDSCHEMA:IDSCHEMA|IUD';

wwv_flow_api.create_page_process(
  p_id     => 1433230964266848 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 44,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 1433426966266848 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 44,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
...
prompt  ...PAGE 45: Report on CIP_SCHEMA_DETAIL
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 45
 ,p_tab_set => 'TS1'
 ,p_name => 'Report on CIP_SCHEMA_DETAIL'
 ,p_step_title => 'List of CIP Schemas Details'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110805143508'
  );
null;
...
wwv_flow_api.create_page_plug (
  p_id=> 1441709548307703 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 45,
...
wwv_flow_api.create_worksheet(
  p_id=> 1441911447307704+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 45,
  p_region_id=> 1441709548307703+wwv_flow_api.g_id_offset,
  p_name=> 'CIP Schema Details',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  p_max_row_count=> '10000',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:46:&SESSION.::&DEBUG.::P46_IDSCHEMADET:#IDSCHEMADET#',
  p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif"  border="0">',
  p_allow_exclude_null_values=>'N',
  p_allow_hide_extra_columns=>'N',
  p_icon_view_enabled_yn=>'N',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1442024898307704+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 45,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1444024768323052+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 45,
  p_worksheet_id => 1441911447307704+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1444111648323052+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 45,
  p_worksheet_id => 1441911447307704+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PRODUCTGROUP',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1442329196307704+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 45,
  p_worksheet_id => 1441911447307704+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1442422421307705+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 45,
  p_worksheet_id => 1441911447307704+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1442514025307705+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 45,
  p_worksheet_id => 1441911447307704+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1442629531307705+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 45,
  p_worksheet_id => 1441911447307704+wwv_flow_api.g_id_offset,
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'IDSCHEMADET:SCHEMA:PRODUCTGROUP:PRODSPLIT:HVALUE:YVALUE:KSO';

wwv_flow_api.create_worksheet_rpt(
  p_id => 1444924468351356+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 45,
  p_worksheet_id => 1441911447307704+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1442924215307705 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 45,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1442823807307705 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 45,
  p_button_sequence=> 30,
  ...
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=100:46:&SESSION.::&DEBUG.:46',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
prompt  ...PAGE 46: Form on CIP_SCHEMA_DETAIL
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 46
 ,p_tab_set => 'TS1'
 ,p_name => 'Form on CIP_SCHEMA_DETAIL'
 ,p_step_title => 'CIP Schema Details'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110805143542'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1437618521307695 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 46,
  p_plug_name=> 'Details',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1443130803307705 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 46,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1437908548307695 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 46,
  p_button_sequence=> 30,
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P46_IDSCHEMADET',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 1438214517307695 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 46,
  p_button_sequence=> 10,
  p_button_plug_id => 1437618521307695+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1437803623307695 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 46,
  p_button_sequence=> 40,
  p_button_plug_id => 1437618521307695+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1438026708307695 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 46,
  p_button_sequence=> 20,
  p_button_plug_id => 1437618521307695+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>1438803641307696 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 46,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1439025077307696 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 46,
  p_name=>'P46_IDSCHEMADET',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 1437618521307695+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Idschemadet',
  p_source=>'IDSCHEMADET',
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_HIDDEN',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1439201650307696 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 46,
  p_name=>'P46_IDSCHEMA',
  p_data_type=> 'VARCHAR',
  ...
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_lov=> 'select schema_name, idschema from cip_schema',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 32,
  p_cMaxlength=> 255,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1439424771307696 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 46,
  p_name=>'P46_IDPRODGR',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1439620280307696 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 46,
  p_name=>'P46_PRODSPLIT',
  p_data_type=> 'VARCHAR',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 40,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1439803745307696 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 46,
  p_name=>'P46_HVALUE',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1440029402307697 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 46,
  p_name=>'P46_YVALUE',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1440210387307697 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 46,
  p_name=>'P46_KSO',
  p_data_type=> 'VARCHAR',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:CIP_SCHEMA_DETAIL:P46_IDSCHEMADET:IDSCHEMADET';

wwv_flow_api.create_page_process(
  p_id     => 1440516870307701 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 46,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
...
wwv_flow_api.create_page_process(
  p_id     => 1440711753307701 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 46,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:CIP_SCHEMA_DETAIL:P46_IDSCHEMADET:IDSCHEMADET|IUD';

wwv_flow_api.create_page_process(
  p_id     => 1440906345307702 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 46,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 1441113797307702 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 46,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
...
prompt  ...PAGE 47: Report on CIP_SCHEMA_EMPL
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 47
 ,p_tab_set => 'TS1'
 ,p_name => 'Report on CIP_SCHEMA_EMPL'
 ,p_step_title => 'List of CIP Schemas Employees'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110805152911'
  );
null;
...
wwv_flow_api.create_page_plug (
  p_id=> 1449216269366881 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 47,
...
wwv_flow_api.create_worksheet(
  p_id=> 1449410079366882+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 47,
  p_region_id=> 1449216269366881+wwv_flow_api.g_id_offset,
  p_name=> 'CIP Schema Employee',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  p_max_row_count=> '10000',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:48:&SESSION.::&DEBUG.::P48_IDCIPEMP:#IDCIPEMP#',
  p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif"  border="0">',
  p_allow_exclude_null_values=>'N',
  p_allow_hide_extra_columns=>'N',
  p_icon_view_enabled_yn=>'N',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1449513432366884+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 47,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1451232181410432+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 47,
  p_worksheet_id => 1449410079366882+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1451319984410433+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 47,
  p_worksheet_id => 1449410079366882+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1449707025366885+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 47,
  p_worksheet_id => 1449410079366882+wwv_flow_api.g_id_offset,
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'IDCIPEMP:SCHEMANAME:EMPLOYEE:EMPLTYPE';

wwv_flow_api.create_worksheet_rpt(
  p_id => 1451818722434920+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 47,
  p_worksheet_id => 1449410079366882+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1450104139366885 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 47,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1450023981366885 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 47,
  p_button_sequence=> 30,
  ...
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=100:48:&SESSION.::&DEBUG.:48',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
prompt  ...PAGE 48: Form on CIP_SCHEMA_EMPL
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 48
 ,p_tab_set => 'TS1'
 ,p_name => 'Form on CIP_SCHEMA_EMPL'
 ,p_step_title => 'CIP Schema Employee Details'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110805152831'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1445720302366874 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 48,
  p_plug_name=> 'Details',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1450314720366886 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 48,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1446004817366874 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 48,
  p_button_sequence=> 30,
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P48_IDCIPEMP',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 1446324304366874 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 48,
  p_button_sequence=> 10,
  p_button_plug_id => 1445720302366874+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1445913175366874 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 48,
  p_button_sequence=> 40,
  p_button_plug_id => 1445720302366874+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1446126568366874 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 48,
  p_button_sequence=> 20,
  p_button_plug_id => 1445720302366874+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>1446904081366874 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 48,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1447115229366875 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 48,
  p_name=>'P48_IDCIPEMP',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 1445720302366874+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Idcipemp',
  p_source=>'IDCIPEMP',
  p_source_type=> 'DB_COLUMN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1447325874366875 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 48,
  p_name=>'P48_IDSCHEMA',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1447503102366875 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 48,
  p_name=>'P48_EMPLTYPE',
  p_data_type=> 'VARCHAR',
  ...
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_lov=> 'STATIC2:SKAM;SKAM,KAM;KAM,SREP;SREP,REP;REP',
  p_lov_display_null=> 'YES',
  p_lov_translated=> 'N',
  p_lov_null_text=>'--None--',
  p_lov_null_value=> '',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1447731609366875 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 48,
  p_name=>'P48_IDKAMREP',
  p_data_type=> 'VARCHAR',
  ...
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_lov=> 'select employee_name, employee_id from employee where employee_type = :p48_empltype',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:CIP_SCHEMA_EMPL:P48_IDCIPEMP:IDCIPEMP';

wwv_flow_api.create_page_process(
  p_id     => 1448020025366875 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 48,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
...
wwv_flow_api.create_page_process(
  p_id     => 1448223928366875 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 48,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:CIP_SCHEMA_EMPL:P48_IDCIPEMP:IDCIPEMP|IUD';

wwv_flow_api.create_page_process(
  p_id     => 1448401732366879 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 48,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 1448600295366879 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 48,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110803205217'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1568724101864879 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 49,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1569130600864882 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 49,
  p_plug_name=> 'Geography',
  p_region_name=>'',
...
wwv_flow_api.create_jstree(
  p_id => 1569300626864885+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id => 49,
  p_region_id => 1569130600864882+wwv_flow_api.g_id_offset,
  p_tree_template     =>'classic',
  p_tree_source             =>'GEOGRAPHY',
  p_tree_query             =>a1,
  p_tree_node_title   =>'GEOGRAPHY_PARENT',
  p_tree_node_value   =>'GEOGRAPHY_NAME',
  p_tree_node_icon   =>'',
  p_tree_node_link   =>'',
  p_tree_node_hints   =>'GEOGRAPHY_TYPE',
  p_tree_start_item   =>'GEOGRAPHY_PARENT',
  p_tree_start_value   =>'',
  p_tree_button_option   =>'CONTRACT_ALL:EXPAND_ALL',
  p_show_node_link   =>'',
  p_node_link_checksum_type   =>null,
...
wwv_flow_api.create_page_button(
  p_id             => 1575005423914152 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 49,
  p_button_sequence=> 20,
...
wwv_flow_api.create_page_button(
  p_id             => 1569511863864895 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 49,
  p_button_sequence=> 10,
  p_button_plug_id => 1569130600864882+wwv_flow_api.g_id_offset,
  ...
  p_button_position=> 'REGION_TEMPLATE_CREATE',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'javascript:apex.widget.tree.collapse_all(''tree'||to_char(1569300626864885+wwv_flow_api.g_id_offset)||''');',
  p_button_execute_validations=>'Y',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 1569727498864895 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 49,
  p_button_sequence=> 10,
  p_button_plug_id => 1569130600864882+wwv_flow_api.g_id_offset,
  ...
  p_button_position=> 'REGION_TEMPLATE_CREATE',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'javascript:apex.widget.tree.expand_all(''tree'||to_char(1569300626864885+wwv_flow_api.g_id_offset)||''');',
  p_button_execute_validations=>'Y',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
prompt  ...PAGE 50: Form on GEOGRAPHY
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 50
 ,p_tab_set => 'TS1'
 ,p_name => 'Form on GEOGRAPHY'
 ,p_step_title => 'Geography Details'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110803205255'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1570512208881677 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 50,
  p_plug_name=> 'Details',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1573701364881695 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 50,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1570803416881681 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 50,
  p_button_sequence=> 30,
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P50_GEOGRAPHY_ID',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 1571102684881681 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 50,
  p_button_sequence=> 10,
  p_button_plug_id => 1570512208881677+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1570703784881681 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 50,
  p_button_sequence=> 40,
  p_button_plug_id => 1570512208881677+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1570924498881681 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 50,
  p_button_sequence=> 20,
  p_button_plug_id => 1570512208881677+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>1571716996881682 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 50,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1571926682881682 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 50,
  p_name=>'P50_GEOGRAPHY_ID',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 1570512208881677+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Geography Id',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1572111667881692 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 50,
  p_name=>'P50_GEOGRAPHY_PARENT',
  p_data_type=> 'VARCHAR',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 30,
  ...
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Parent',
  p_source=>'GEOGRAPHY_PARENT',
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_lov=> 'select geography_name, geography_id from geography',
  p_lov_display_null=> 'YES',
  p_lov_translated=> 'N',
  p_lov_null_text=>'Без подчинения',
  p_lov_null_value=> '',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1572302448881693 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 50,
  p_name=>'P50_GEOGRAPHY_TYPE',
  p_data_type=> 'VARCHAR',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 20,
  ...
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Type',
  p_source=>'GEOGRAPHY_TYPE',
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_lov=> 'STATIC2:Area;AREA,Sub Area;SUBAREA,Region;REGION,City;CITY',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 32,
  p_cMaxlength=> 100,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1572532663881693 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 50,
  p_name=>'P50_GEOGRAPHY_NAME',
  p_data_type=> 'VARCHAR',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 40,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1572710155881694 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 50,
  p_name=>'P50_GEOGRAPHY_CAPITAL',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 50,
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:GEOGRAPHY:P50_GEOGRAPHY_ID:GEOGRAPHY_ID';

wwv_flow_api.create_page_process(
  p_id     => 1573007847881694 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 50,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
...
wwv_flow_api.create_page_process(
  p_id     => 1573231884881695 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 50,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:GEOGRAPHY:P50_GEOGRAPHY_ID:GEOGRAPHY_ID|IUD';

wwv_flow_api.create_page_process(
  p_id     => 1573428761881695 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 50,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 1573619485881695 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 50,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
...
prompt  ...PAGE 52: Report on AFFILIATION
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 52
 ,p_tab_set => 'TS1'
 ,p_name => 'Report on AFFILIATION'
 ,p_step_title => 'Employee-Geography'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110805110516'
  );
null;
...
wwv_flow_api.create_page_plug (
  p_id=> 1581713499170932 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_plug_name=> 'Links',
  p_region_name=>'',
...
wwv_flow_api.create_worksheet(
  p_id=> 1581923893170934+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_region_id=> 1581713499170932+wwv_flow_api.g_id_offset,
  p_name=> 'Links',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:56:&SESSION.::&DEBUG.::P56_AFFILIATION_ID:#AFFILIATION_ID#',
  p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif"  border="0">',
  p_allow_exclude_null_values=>'N',
  p_allow_hide_extra_columns=>'N',
  p_icon_view_enabled_yn=>'N',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1582001991170969+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1582121474170976+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_worksheet_id => 1581923893170934+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1587322203339847+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_worksheet_id => 1581923893170934+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1587424205339847+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_worksheet_id => 1581923893170934+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1582409647170977+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_worksheet_id => 1581923893170934+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1582523326170978+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_worksheet_id => 1581923893170934+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1582604475170978+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_worksheet_id => 1581923893170934+wwv_flow_api.g_id_offset,
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'AFFILIATION_ID:AFFILIATION_TYPE:FROM_ID:TO_ID:STATUS:FROM_DATE:TO_DATE';

wwv_flow_api.create_worksheet_rpt(
  p_id => 1584903362249221+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_worksheet_id => 1581923893170934+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1582928307170979 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1582820528170978 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 52,
  p_button_sequence=> 30,
  ...
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=100:56:&SESSION.::&DEBUG.:56',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
prompt  ...PAGE 53: Form on TRANSACTIONS_DATA
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 53
 ,p_tab_set => 'TS1'
 ,p_name => 'Form on TRANSACTIONS_DATA'
 ,p_step_title => 'Form on TRANSACTIONS_DATA'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_javascript_code => 
'var htmldb_delete_message=''"DELETE_CONFIRM_MSG"'';'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110725010625'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1487225001620267 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 53,
  p_plug_name=> 'Details',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1494712729691153 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 53,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1487514383620268 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 53,
  p_button_sequence=> 30,
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P53_IDTRAN',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 1487825235620268 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 53,
  p_button_sequence=> 10,
  p_button_plug_id => 1487225001620267+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1487432495620268 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 53,
  p_button_sequence=> 40,
  p_button_plug_id => 1487225001620267+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1487630044620268 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 53,
  p_button_sequence=> 20,
  p_button_plug_id => 1487225001620267+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>1488410107620269 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 53,
  p_branch_action=> 'f?p=&APP_ID.:3:&SESSION.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1488601112620269 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 53,
  p_name=>'P53_IDTRAN',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1489031946620269 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 53,
  p_name=>'P53_KAMREP',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1489223749620270 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 53,
  p_name=>'P53_IDKAMREP',
  p_data_type=> 'VARCHAR',
  ...
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_lov=> 'select emp_name || '' - '' || emp_type, emp_id from all_employees where emp_type = ''KAM''',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 32,
  p_cMaxlength=> 255,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1489423905620270 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 53,
  p_name=>'P53_IDCLIENT',
  p_data_type=> 'VARCHAR',
  ...
  p_lov=> 'select client || '' - '' || city, idclient from clients',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 120,
  p_cMaxlength=> 255,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1489619877620270 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 53,
  p_name=>'P53_IDPROD',
  p_data_type=> 'VARCHAR',
  ...
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_lov=> 'select prod, idprod from products',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 32,
  p_cMaxlength=> 255,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1490216835620270 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 53,
  p_name=>'P53_PACKS_PLAN',
  p_data_type=> 'VARCHAR',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 130,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1490428575620271 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 53,
  p_name=>'P53_PACKS',
  p_data_type=> 'VARCHAR',
  ...
  p_source=>'PACKS',
  p_source_type=> 'DB_COLUMN',
  p_source_post_computation => ':P53_packs_plan',
  p_display_as=> 'NATIVE_HIDDEN',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 32,
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:TRANSACTIONS_DATA:P53_IDTRAN:IDTRAN';

wwv_flow_api.create_page_process(
  p_id     => 1490701398620271 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 53,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
...
wwv_flow_api.create_page_process(
  p_id     => 1490918490620271 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 53,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:TRANSACTIONS_DATA:P53_IDTRAN:IDTRAN|IUD';

wwv_flow_api.create_page_process(
  p_id     => 1491124755620271 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 53,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 1491318366620271 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 53,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
...
prompt  ...PAGE 54: Report on TRANSACTIONS_DATA
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 54
 ,p_tab_set => 'TS1'
 ,p_name => 'Report on TRANSACTIONS_DATA'
 ,p_step_title => 'Report on TRANSACTIONS_DATA'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_help_text => 
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110802200854'
  );
null;
...
'(select prod from products where idprod=td."IDPROD") Product,'||chr(10)||
'(select hy from half_year where idhy = td."IDHY") HalfYear,'||chr(10)||
'(select y from years where idy ';

s:=s||'= td."IDY") Year,'||chr(10)||
...
wwv_flow_api.create_page_plug (
  p_id=> 1503617515850225 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 54,
  p_plug_name=> 'Fact',
  p_region_name=>'',
...
wwv_flow_api.create_worksheet(
  p_id=> 1503811879850231+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 54,
  p_region_id=> 1503617515850225+wwv_flow_api.g_id_offset,
  p_name=> 'Fact',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:55:&SESSION.::&DEBUG.::P55_IDTRAN:#IDTRAN#',
  p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif"  border="0">',
  p_allow_exclude_null_values=>'N',
  p_allow_hide_extra_columns=>'N',
  p_icon_view_enabled_yn=>'N',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1503910375850238+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 54,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1506811409870561+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 54,
  p_worksheet_id => 1503811879850231+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'KAMREPNAME',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1506926696870566+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 54,
  p_worksheet_id => 1503811879850231+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'CLIENT',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1507022568870566+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 54,
  p_worksheet_id => 1503811879850231+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'CLIENTCITY',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1507113267870569+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 54,
  p_worksheet_id => 1503811879850231+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PRODUCT',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1504713158850248+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 54,
  p_worksheet_id => 1503811879850231+wwv_flow_api.g_id_offset,
  ...
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'I',
  p_column_label           =>'Packs Fack',
  p_report_label           =>'Packs Fack',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'IDTRAN:KAMREPNAME:CLIENT:CLIENTCITY:PRODUCT:HALFYEAR:YEAR:MONTH:DISTRIBUTOR:PACKS_FACK';

wwv_flow_api.create_worksheet_rpt(
  p_id => 1507729417875768+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 54,
  p_worksheet_id => 1503811879850231+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1505028012850249 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 54,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1504924677850249 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 54,
  p_button_sequence=> 30,
  ...
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=100:55:&SESSION.::&DEBUG.:55',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
prompt  ...PAGE 55: Form on TRANSACTIONS_DATA
--
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110725010911'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1498732337850175 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 55,
  p_plug_name=> 'Details',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1505205510850251 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 55,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1499014996850180 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 55,
  p_button_sequence=> 30,
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P55_IDTRAN',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 1499329640850183 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 55,
  p_button_sequence=> 10,
  p_button_plug_id => 1498732337850175+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1498924081850180 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 55,
  p_button_sequence=> 40,
  p_button_plug_id => 1498732337850175+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1499129533850180 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 55,
  p_button_sequence=> 20,
  p_button_plug_id => 1498732337850175+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>1499900560850192 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 55,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1500130181850194 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 55,
  p_name=>'P55_IDTRAN',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1500329883850199 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 55,
  p_name=>'P55_KAMREP',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1500513500850200 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 55,
  p_name=>'P55_IDKAMREP',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1500727959850201 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 55,
  p_name=>'P55_IDCLIENT',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1500909191850202 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 55,
  p_name=>'P55_IDPROD',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1501332097850204 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 55,
  p_name=>'P55_IDY',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1501728797850205 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 55,
  p_name=>'P55_IDWS',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1501910169850205 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 55,
  p_name=>'P55_PACKS_FACK',
  p_data_type=> 'VARCHAR',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 140,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1502127963850215 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 55,
  p_name=>'P55_PACKS',
  p_data_type=> 'VARCHAR',
  ...
  p_source=>'PACKS',
  p_source_type=> 'DB_COLUMN',
  p_source_post_computation => ':P55_PACKS_FACK',
  p_display_as=> 'NATIVE_HIDDEN',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 32,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1511608349973798 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 55,
  p_name=>'P55_TRANSACTION_TYPE',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 160,
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:TRANSACTIONS_DATA:P55_IDTRAN:IDTRAN';

wwv_flow_api.create_page_process(
  p_id     => 1502404873850216 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 55,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
...
wwv_flow_api.create_page_process(
  p_id     => 1502626662850221 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 55,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:TRANSACTIONS_DATA:P55_IDTRAN:IDTRAN|IUD';

wwv_flow_api.create_page_process(
  p_id     => 1502802755850221 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 55,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 1503006470850222 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 55,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
...
prompt  ...PAGE 56: Form on AFFILIATION
--
...
'No help is available for this page.'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110805105600'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1577626265170854 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 56,
  p_plug_name=> 'Details',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1583122628170979 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 56,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1577925363170860 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 56,
  p_button_sequence=> 30,
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P56_AFFILIATION_ID',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 1578213766170861 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 56,
  p_button_sequence=> 10,
  p_button_plug_id => 1577626265170854+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1577830088170860 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 56,
  p_button_sequence=> 40,
  p_button_plug_id => 1577626265170854+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 1578015272170860 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 56,
  p_button_sequence=> 20,
  p_button_plug_id => 1577626265170854+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>1578823197170869 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 56,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1579029105170871 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 56,
  p_name=>'P56_AFFILIATION_ID',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 1577626265170854+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Affiliation Id',
  p_source=>'AFFILIATION_ID',
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_HIDDEN',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1579227478170893 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 56,
  p_name=>'P56_AFFILIATION_TYPE',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 20,
  ...
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Type',
  p_source=>'AFFILIATION_TYPE',
  p_source_type=> 'DB_COLUMN',
  p_source_post_computation => '''EMPL_GEO''',
  p_display_as=> 'NATIVE_HIDDEN',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 32,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1579419805170897 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 56,
  p_name=>'P56_FROM_ID',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1579625251170897 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 56,
  p_name=>'P56_TO_ID',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1579819499170897 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 56,
  p_name=>'P56_STATUS',
  p_data_type=> 'VARCHAR',
  ...
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_lov=> 'STATIC2:Active;ACTV,Inactive;INAC',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 32,
  p_cMaxlength=> 255,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1580001750170898 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 56,
  p_name=>'P56_FROM_DATE',
  p_data_type=> 'VARCHAR',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 60,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1580225578170898 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 56,
  p_name=>'P56_TO_DATE',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1587931234569524 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 56,
  p_name=>'P56_EMPLOYEETYPE',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 25,
  ...
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Employee Type',
  p_source=>'select employee_type from employee where employee_id = :p56_from_id',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_lov=> 'STATIC2:SKAM;SKAM,KAM;KAM,SREP;SREP,REP;REP',
  p_lov_display_null=> 'YES',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1588514312592994 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 56,
  p_name=>'P56_GEOTYPE',
  p_data_type=> 'VARCHAR',
  ...
  p_source=>'select geography_type from geography where geography_id = :p56_to_id',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_lov=> 'STATIC2:Area;AREA,Sub Area;SUBAREA,Region;REGION,City;CITY',
  p_lov_display_null=> 'YES',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:AFFILIATION:P56_AFFILIATION_ID:AFFILIATION_ID';

wwv_flow_api.create_page_process(
  p_id     => 1580505981170899 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 56,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
...
wwv_flow_api.create_page_process(
  p_id     => 1580726450170906 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 56,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:AFFILIATION:P56_AFFILIATION_ID:AFFILIATION_ID|IUD';

wwv_flow_api.create_page_process(
  p_id     => 1580932195170906 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 56,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 1581124896170907 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 56,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page (
 ...
 ,p_step_template => 2613418424032708 + wwv_flow_api.g_id_offset
 ,p_page_is_public_y_n => 'N'
 ,p_cache_page_yn => 'N'
 ,p_last_updated_by => 'ADMIN'
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 2622042624033476 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 101,
  p_plug_name=> 'Login',
  p_region_name=>'',
...
begin
wwv_flow_api.create_page_item(
  p_id=>2622136965033562 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
...
begin
wwv_flow_api.create_page_item(
  p_id=>2622227521033592 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
...
begin
wwv_flow_api.create_page_item(
  p_id=>2622323582033592 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  p_name=>'P101_LOGIN',
  p_data_type=> '',
...
wwv_flow_api.create_page_process(
  p_id     => 2622529060033623 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 2622420110033600 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 20,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 2622738025033627 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 2622616251033624 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
...
wwv_flow_api.create_page (
 ...
 ,p_include_apex_css_js_yn => 'Y'
 ,p_autocomplete_on_off => 'OFF'
 ,p_step_template => 2614323966032776 + wwv_flow_api.g_id_offset
 ,p_page_is_public_y_n => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_page_comment => 'This page was generated by the feedback wizard'
 ,p_last_updated_by => 'ADMIN'
 ,p_last_upd_yyyymmddhh24miss => '20110712010008'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 2645526456136993 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 102,
...
wwv_flow_api.create_page_button(
  p_id             => 2648533464137084 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 102,
  p_button_sequence=> 20,
...
wwv_flow_api.create_page_button(
  p_id             => 2648327135137070 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 102,
  p_button_sequence=> 10,
  p_button_plug_id => 2645526456136993+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_item(
  p_id=>2645719535137030 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 102,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 2645526456136993+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> '',
...
wwv_flow_api.create_page_item(
  p_id=>2646242262137052 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 102,
  p_name=>'P102_PAGE_ID',
  p_data_type=> '',
...
begin
wwv_flow_api.create_page_item(
  p_id=>2646721449137060 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 102,
  p_name=>'P102_A',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_item(
  p_id=>2646942313137062 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 102,
...
begin
wwv_flow_api.create_page_item(
  p_id=>2647436325137064 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 102,
  p_name=>'P102_X',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_item(
  p_id=>2647637679137064 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 102,
...
begin
wwv_flow_api.create_page_item(
  p_id=>2648135992137066 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 102,
  p_name=>'P102_Y',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_process(
  p_id     => 2648740576137088 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 102,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 2648926935137100 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 102,
  p_process_sequence=> 20,
  p_process_point=> 'AFTER_SUBMIT',
...
prompt  ...lists
--
--application/shared_components/navigation/lists/list_years
...
wwv_flow_api.create_list_item (
  p_id=> 2959112546268040 + wwv_flow_api.g_id_offset,
  p_list_id=> 1601503312321467 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_list_item (
  p_id=> 2966414155334702 + wwv_flow_api.g_id_offset,
  p_list_id=> 1601503312321467 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list_item (
  p_id=> 2999319901601267 + wwv_flow_api.g_id_offset,
  p_list_id=> 1601503312321467 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
--application/shared_components/navigation/lists/employee
...
wwv_flow_api.create_list_item (
  p_id=> 2949519276080796 + wwv_flow_api.g_id_offset,
  p_list_id=> 1608712148361824 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  p_list_item_display_sequence=>230,
  p_list_item_link_text=> 'Business Units',
  p_list_item_link_target=> 'f?p=&APP_ID.:15:&SESSION.::&DEBUG.::::',
  p_list_item_icon=> 'menu/home_32.gif',
  p_list_countclicks_y_n=> 'N',
  p_list_text_01=> '',
  p_list_item_current_type=> 'COLON_DELIMITED_PAGE_LIST',
  p_list_item_owner=> '');
...
wwv_flow_api.create_list_item (
  p_id=> 3129151018256926 + wwv_flow_api.g_id_offset,
  p_list_id=> 1608712148361824 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list_item (
  p_id=> 1451025077370537 + wwv_flow_api.g_id_offset,
  p_list_id=> 1608712148361824 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  p_list_item_display_sequence=>390,
  p_list_item_link_text=> 'CIP Schema Employee',
...
wwv_flow_api.create_list_item (
  p_id=> 1404202100379772 + wwv_flow_api.g_id_offset,
  p_list_id=> 1608712148361824 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  p_list_item_display_sequence=>400,
  p_list_item_link_text=> 'Payout Curve',
...
--application/shared_components/navigation/lists/geography
...
wwv_flow_api.create_list_item (
  p_id=> 3185622027248861 + wwv_flow_api.g_id_offset,
  p_list_id=> 1615432018377056 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  p_list_item_display_sequence=>390,
  p_list_item_link_text=> 'Geography',
...
wwv_flow_api.create_list_item (
  p_id=> 3199428229557863 + wwv_flow_api.g_id_offset,
  p_list_id=> 1615432018377056 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  p_list_item_display_sequence=>400,
  p_list_item_link_text=> 'Employee Geography Link',
...
--application/shared_components/navigation/lists/products
...
wwv_flow_api.create_list_item (
  p_id=> 1410422364423544 + wwv_flow_api.g_id_offset,
  p_list_id=> 1622809340408319 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list_item (
  p_id=> 1418402587465115 + wwv_flow_api.g_id_offset,
  p_list_id=> 1622809340408319 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  ...
  p_list_item_icon=> 'menu/printer_32.gif',
  p_list_countclicks_y_n=> 'N',
  p_list_text_01=> '',
  p_list_item_current_type=> 'COLON_DELIMITED_PAGE_LIST',
  p_list_item_owner=> '');
...
wwv_flow_api.create_list_item (
  p_id=> 1427601566616213 + wwv_flow_api.g_id_offset,
  p_list_id=> 1622809340408319 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
--application/shared_components/navigation/lists/cip
...
wwv_flow_api.create_list_item (
  p_id=> 1436007490270784 + wwv_flow_api.g_id_offset,
  p_list_id=> 1624524493431663 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  p_list_item_display_sequence=>150,
  p_list_item_link_text=> 'CIP Schema',
...
wwv_flow_api.create_list_item (
  p_id=> 1443818750311928 + wwv_flow_api.g_id_offset,
  p_list_id=> 1624524493431663 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  p_list_item_display_sequence=>160,
  p_list_item_link_text=> 'CIP Schema Details',
...
--application/shared_components/navigation/lists/pages
...
wwv_flow_api.create_list_item (
  p_id=> 2735220329413352 + wwv_flow_api.g_id_offset,
  p_list_id=> 2735014142413345 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  p_list_item_display_sequence=>10,
  p_list_item_link_text=> 'Areas',
...
wwv_flow_api.create_list_item (
  p_id=> 2735518727413353 + wwv_flow_api.g_id_offset,
  p_list_id=> 2735014142413345 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list_item (
  p_id=> 1340600201716922 + wwv_flow_api.g_id_offset,
  p_list_id=> 2735014142413345 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list_item (
  p_id=> 1370222533035600 + wwv_flow_api.g_id_offset,
  p_list_id=> 2735014142413345 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  p_list_item_display_sequence=>35,
  p_list_item_link_text=> 'Distributors',
...
wwv_flow_api.create_list_item (
  p_id=> 1350602897812302 + wwv_flow_api.g_id_offset,
  p_list_id=> 2735014142413345 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list_item (
  p_id=> 1357001137934828 + wwv_flow_api.g_id_offset,
  p_list_id=> 2735014142413345 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list_item (
  p_id=> 1364302747001490 + wwv_flow_api.g_id_offset,
  p_list_id=> 2735014142413345 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list_item (
  p_id=> 1397208493268055 + wwv_flow_api.g_id_offset,
  p_list_id=> 2735014142413345 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list_item (
  p_id=> 1377619818138950 + wwv_flow_api.g_id_offset,
  p_list_id=> 2735014142413345 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  p_list_item_display_sequence=>80,
  p_list_item_link_text=> 'REPs',
  p_list_item_link_target=> 'f?p=&APP_ID.:25:&SESSION.::&DEBUG.::::',
  p_list_item_icon=> 'menu/form_64.gif',
  p_list_item_disp_cond_type=> 'NEVER',
  p_list_item_disp_condition=> '',
  p_list_countclicks_y_n=> 'N',
  p_list_text_01=> '',
...
wwv_flow_api.create_list_item (
  p_id=> 1384721905215232 + wwv_flow_api.g_id_offset,
  p_list_id=> 2735014142413345 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  p_list_item_display_sequence=>90,
  p_list_item_link_text=> 'Senior KAMs',
...
wwv_flow_api.create_list_item (
  p_id=> 1390824938234956 + wwv_flow_api.g_id_offset,
  p_list_id=> 2735014142413345 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  p_list_item_display_sequence=>100,
  p_list_item_link_text=> 'KAMs',
...
wwv_flow_api.create_list_item (
  p_id=> 1520231943893052 + wwv_flow_api.g_id_offset,
  p_list_id=> 2735014142413345 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list_item (
  p_id=> 1570016196869953 + wwv_flow_api.g_id_offset,
  p_list_id=> 2735014142413345 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list_item (
  p_id=> 1583822399178955 + wwv_flow_api.g_id_offset,
  p_list_id=> 2735014142413345 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_menu (
  p_id=> 2622829076033627 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> ' Breadcrumb');
 
wwv_flow_api.create_menu_option (
  p_id=>1317430578508822 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_menu_option (
  p_id=>1317718202508828 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>1317430578508822 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
...
wwv_flow_api.create_menu_option (
  p_id=>1339621825710699 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>2733925259399158 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Business Units',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1339907885710699 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>1339621825710699 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Details',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1349703190749650 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>2733925259399158 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
...
wwv_flow_api.create_menu_option (
  p_id=>1350007286749650 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>1349703190749650 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Details',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1356126056929073 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>2733925259399158 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Years',
...
wwv_flow_api.create_menu_option (
  p_id=>1356402279929073 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>1356126056929073 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Details',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1363522629990298 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>2733925259399158 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Half Year',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1363801749990298 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>1363522629990298 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Details',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1369602630030500 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>2733925259399158 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Distributors',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1369906890030500 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>1369602630030500 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Details',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1376611209110043 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>2733925259399158 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Reps',
...
wwv_flow_api.create_menu_option (
  p_id=>1376908456110043 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>1376611209110043 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Details',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1383704175188908 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>2733925259399158 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Senior KAMs',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1384010085188908 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>1383704175188908 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Details',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1390304886233152 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>2733925259399158 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'KAMs',
...
wwv_flow_api.create_menu_option (
  p_id=>1390610126233153 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>1390304886233152 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Details',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1396724234265297 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>2733925259399158 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Months',
...
wwv_flow_api.create_menu_option (
  p_id=>1397008672265297 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>1396724234265297 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Details',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1403704358375553 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>2733925259399158 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Payout Curve',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1404016928375553 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>1403704358375553 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Details',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1409913058418621 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>2733925259399158 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Product Group',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1410219562418621 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>1409913058418621 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Details',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1417916319461196 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>2733925259399158 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
...
wwv_flow_api.create_menu_option (
  p_id=>1418224576461196 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>1417916319461196 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Details',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1426906029612961 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>2733925259399158 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
...
wwv_flow_api.create_menu_option (
  p_id=>1427207658612961 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>1426906029612961 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Details',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1435317042266853 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>2733925259399158 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'CIP Schema',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1435608063266854 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>1435317042266853 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Details',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1443320578307706 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>2733925259399158 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'CIP Schema Details',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1443600521307706 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>1443320578307706 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Details',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1450505809366886 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>2733925259399158 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'CIP Schema Employee',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1450813039366886 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>1450505809366886 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Details',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1495020375691167 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>2665744166188244 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Details',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1505421520850251 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_menu_option (
  p_id=>1505732251850261 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>1505421520850251 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Details',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1519825058889786 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>2733925259399158 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
...
wwv_flow_api.create_menu_option (
  p_id=>1557421443934052 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>1519825058889786 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Details',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1569027200864882 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>2733925259399158 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
...
wwv_flow_api.create_menu_option (
  p_id=>1574006943881695 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>1569027200864882 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Details',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1583313118170979 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>2733925259399158 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Links',
...
wwv_flow_api.create_menu_option (
  p_id=>1583630415170981 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>1583313118170979 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Details',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>2623345844033704 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>0,
  p_option_sequence=>10,
  p_short_name=>'Home',
...
wwv_flow_api.create_menu_option (
  p_id=>2665744166188244 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>2623345844033704 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Plan',
...
wwv_flow_api.create_menu_option (
  p_id=>2693919679513084 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>2623345844033704 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'IMS Cube',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>2711919379052933 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>2623345844033704 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
...
wwv_flow_api.create_menu_option (
  p_id=>2733925259399158 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>2623345844033704 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Dictionaries',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>2751329544483284 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>2733925259399158 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Areas',
...
wwv_flow_api.create_menu_option (
  p_id=>2751615192483318 + wwv_flow_api.g_id_offset,
  p_menu_id=>2622829076033627 + wwv_flow_api.g_id_offset,
  p_parent_id=>2751329544483284 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Details',
  p_long_name=>'',
...
prompt  ......Page template 2613418424032708
...
wwv_flow_api.create_template(
  p_id=> 2613418424032708 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Login',
  p_body_title=> '',
...
prompt  ......Page template 2613530819032753
...
wwv_flow_api.create_template(
  p_id=> 2613530819032753 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 2613624135032754
...
wwv_flow_api.create_template(
  p_id=> 2613624135032754 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 2613746495032755
...
wwv_flow_api.create_template(
  p_id=> 2613746495032755 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 2613829745032755
...
wwv_flow_api.create_template(
  p_id=> 2613829745032755 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 2613916495032767
...
wwv_flow_api.create_template(
  p_id=> 2613916495032767 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 2614023591032769
...
wwv_flow_api.create_template(
  p_id=> 2614023591032769 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 2614131694032775
...
wwv_flow_api.create_template(
  p_id=> 2614131694032775 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 2614238398032776
...
wwv_flow_api.create_template(
  p_id=> 2614238398032776 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 2614323966032776
...
wwv_flow_api.create_template(
  p_id=> 2614323966032776 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Popup',
  p_body_title=> '',
  p_header_template=> c1,
...
prompt  ......Page template 2614445590032776
...
wwv_flow_api.create_template(
  p_id=> 2614445590032776 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 2614546359032776
...
wwv_flow_api.create_template(
  p_id=> 2614546359032776 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 2614631977032777
...
wwv_flow_api.create_template(
  p_id=> 2614631977032777 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 2614746095032777
...
wwv_flow_api.create_template(
  p_id=> 2614746095032777 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 2614833489032777
...
wwv_flow_api.create_template(
  p_id=> 2614833489032777 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......region template 2615319707032802
...
prompt  ......region template 2615419873032830
...
prompt  ......region template 2615541273032830
...
prompt  ......region template 2615629132032830
...
prompt  ......region template 2615732977032830
...
prompt  ......region template 2615829971032830
...
prompt  ......region template 2615925593032831
...
prompt  ......region template 2616045895032831
...
prompt  ......region template 2616128690032831
...
prompt  ......region template 2616223209032831
...
prompt  ......region template 2616320257032831
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 2616320257032831 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 2616419963032831
...
prompt  ......region template 2616534986032831
...
prompt  ......region template 2616623974032832
...
prompt  ......region template 2616718399032833
...
prompt  ......region template 2616816974032833
...
prompt  ......region template 2616925445032833
...
prompt  ......region template 2617022632032833
...
prompt  ......region template 2617124862032835
...
prompt  ......region template 2617218356032836
...
prompt  ......region template 2617342166032836
...
prompt  ......region template 2617421154032836
...
prompt  ......list template 2617535308032836
...
wwv_flow_api.create_list_template (
  p_id=>2617535308032836 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
...
prompt  ......list template 2617620750032873
...
wwv_flow_api.create_list_template (
  p_id=>2617620750032873 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2617727588032874
...
wwv_flow_api.create_list_template (
  p_id=>2617727588032874 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2617842712032874
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2617842712032874 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2617938955032875
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2617938955032875 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2618043586032875
...
wwv_flow_api.create_list_template (
  p_id=>2618043586032875 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2618131670032876
...
wwv_flow_api.create_list_template (
  p_id=>2618131670032876 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2618214108032876
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2618214108032876 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2618331612032876
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2618331612032876 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2618427420032876
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2618427420032876 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2618535648032876
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2618535648032876 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2618636103032876
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2618636103032876 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2618742088032876
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2618742088032876 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2618815205032877
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2618815205032877 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 2618926222032877
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>2618926222032877 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......report template 2619033018032877
...
wwv_flow_api.create_row_template (
  p_id=> 2619033018032877 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 2619127601032951
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 2619127601032951 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 2619242050032952
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 2619242050032952 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 2619320144032953
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 2619320144032953 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 2619417558032953
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 2619417558032953 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 2619534456032954
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 2619534456032954 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 2619627343032954
...
prompt  ......report template 2619717703032954
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 2619717703032954 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 2619827770032954
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 2619827770032954 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 2619920880032954
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 2619920880032954 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 2620045052033008
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 2620045052033008 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 2620143823033009
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 2620143823033009 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 2620221820033009
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 2620221820033009 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 2620333187033009
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 2620333187033009 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 2620420903033009
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 2620420903033009 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 2620525901033083
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 2620525901033083 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
--
prompt  ......template 2621233288033113
 
begin
 
begin
wwv_flow_api.create_popup_lov_template (
  p_id=> 2621233288033113 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 2620632682033084
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 2620632682033084 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 2620818683033107
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 2620818683033107 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 2621016450033107
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 2621016450033107 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......theme 2621330288033150
begin
wwv_flow_api.create_theme (
  p_id =>2621330288033150 + wwv_flow_api.g_id_offset,
  p_flow_id =>wwv_flow.g_flow_id,
  p_theme_id  => 2,
  ...
  p_login_template=>2613418424032708 + wwv_flow_api.g_id_offset,
  p_default_button_template=>2614921232032777 + wwv_flow_api.g_id_offset,
  p_default_region_template=>2616718399032833 + wwv_flow_api.g_id_offset,
  p_default_chart_template =>2615829971032830 + wwv_flow_api.g_id_offset,
  p_default_form_template  =>2615925593032831 + wwv_flow_api.g_id_offset,
  ...
  p_default_label_template=>2620143823033009 + wwv_flow_api.g_id_offset,
  p_default_menu_template=>2620420903033009 + wwv_flow_api.g_id_offset,
  p_default_calendar_template=>2620632682033084 + wwv_flow_api.g_id_offset,
  p_default_list_template=>2618636103032876 + wwv_flow_api.g_id_offset,
  p_default_option_label=>2620143823033009 + wwv_flow_api.g_id_offset,
  p_default_required_label=>2620333187033009 + wwv_flow_api.g_id_offset);
end;
/
...
wwv_flow_api.create_shortcut (
 p_id=> 1533312603883254 + wwv_flow_api.g_id_offset,
 p_flow_id=> wwv_flow.g_flow_id,
...
wwv_flow_api.create_shortcut (
 p_id=> 2657016843153792 + wwv_flow_api.g_id_offset,
 p_flow_id=> wwv_flow.g_flow_id,
